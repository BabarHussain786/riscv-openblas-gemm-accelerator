...
check_family "FP32" "${BASE_DIR}/FP32_SGEMM_RVV_Vector_Kernel" "sgemm_kernel_8x4_*_lmul*_unroll*"
check_family "INT8_iGEMM" "${BASE_DIR}/INT8_iGEMM_8x4" "igemm_kernel_8x4_*_lmul[1248]_unroll*"
check_family "INT8_iGEMM_MF2" "${BASE_DIR}/INT8_iGEMM_8x4" "igemm_kernel_8x4_*_lmulmf2_unroll*"
check_family "INT8_iGEMM_MF4" "${BASE_DIR}/INT8_iGEMM_8x4" "igemm_kernel_8x4_*_lmulmf4_unroll*"
check_family "INT8_iGEMM_MF8" "${BASE_DIR}/INT8_iGEMM_8x4" "igemm_kernel_8x4_*_lmulmf8_unroll*"
check_family "IME" "${BASE_DIR}/IME_KERNEL_8x4_WITH_RVV_AND_SCALAR_FALLBACK" "ime_kernel_8x4_*_unroll*"
