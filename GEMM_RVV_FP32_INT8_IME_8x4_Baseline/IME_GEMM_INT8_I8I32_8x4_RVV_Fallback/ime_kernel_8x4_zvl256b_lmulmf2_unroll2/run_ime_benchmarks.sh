...
LOGFILE="benchmark_ime_kernel_8x4_zvl256b_lmulmf2_unroll2_$(date +%Y%m%d_%H%M%S).log"

echo "======================================================" | tee "$LOGFILE"
echo "IME BENCHMARK (ime_kernel_8x4_zvl256b_lmulmf2_unroll2)" | tee -a "$LOGFILE"
