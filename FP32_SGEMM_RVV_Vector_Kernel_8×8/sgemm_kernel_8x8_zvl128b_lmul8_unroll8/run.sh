...
# Log file updated to reflect m8
LOGFILE="best_shapes_zvl128b_m8_unroll8_$(date +%Y%m%d_%H%M%S).log"

echo "=======================================" | tee "$LOGFILE"
echo "RVV SGEMM LMUL m8 UNROLL 8 BENCHMARK" | tee -a "$LOGFILE"
...
# Run the benchmark matrix shapes
