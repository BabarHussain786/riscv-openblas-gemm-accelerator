...
LOGFILE="benchmark_igemm_kernel_8x8_zvl128b_lmulmf8_unroll8_$(date +%Y%m%d_%H%M%S).log"

echo "======================================================" | tee "$LOGFILE"
echo "RVV IGEMM BENCHMARK (igemm_kernel_8x8_zvl128b_lmulmf8_unroll8)" | tee -a "$LOGFILE"
