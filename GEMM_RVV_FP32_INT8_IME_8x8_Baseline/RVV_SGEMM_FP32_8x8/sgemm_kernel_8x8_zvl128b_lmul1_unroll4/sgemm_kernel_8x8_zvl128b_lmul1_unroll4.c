...
/*
RVV FP KERNEL
Variant: sgemm_kernel_8x8_zvl128b_lmul1_unroll4
Settings:
 LMUL=1 (m1)
 M=8
 N=8
 ...
 Kernel Name: sgemm_kernel_8x8_zvl128b_lmul1_unroll4
*/
#include <stdint.h>
...
#pragma GCC unroll 4
            ...
            ci += ldc - gvl * 0;
            __riscv_vse32_v_f32m1(&C[ci], c2, gvl);
            ci += ldc - gvl * 0;
            __riscv_vse32_v_f32m1(&C[ci], c3, gvl);
            ci += ldc - gvl * 0;
            __riscv_vse32_v_f32m1(&C[ci], c4, gvl);
            ci += ldc - gvl * 0;
            __riscv_vse32_v_f32m1(&C[ci], c5, gvl);
            ci += ldc - gvl * 0;
            __riscv_vse32_v_f32m1(&C[ci], c6, gvl);
            ci += ldc - gvl * 0;
