...
check_family "FP32" "${BASE_DIR}/FP32_SGEMM_RVV_Vector_Kernel_8x8" "sgemm_kernel_8x8_*_lmul*_unroll*"
check_family "INT8_iGEMM_LMUL1" "${BASE_DIR}/INT8_iGEMM_8x8" "igemm_kernel_8x8_*_lmul1_unroll*"
check_family "INT8_iGEMM_LMUL2" "${BASE_DIR}/INT8_iGEMM_8x8" "igemm_kernel_8x8_*_lmul2_unroll*"
check_family "INT8_iGEMM_LMUL4" "${BASE_DIR}/INT8_iGEMM_8x8" "igemm_kernel_8x8_*_lmul4_unroll*"
check_family "INT8_iGEMM_LMUL8" "${BASE_DIR}/INT8_iGEMM_8x8" "igemm_kernel_8x8_*_lmul8_unroll*"
check_family "INT8_iGEMM_MF2" "${BASE_DIR}/INT8_iGEMM_8x8" "igemm_kernel_8x8_*_lmulmf2_unroll*"
check_family "INT8_iGEMM_MF4" "${BASE_DIR}/INT8_iGEMM_8x8" "igemm_kernel_8x8_*_lmulmf4_unroll*"
if [ "${INCLUDE_MF8}" = "1" ]; then
  check_family "INT8_iGEMM_MF8" "${BASE_DIR}/INT8_iGEMM_8x8" "igemm_kernel_8x8_*_lmulmf8_unroll*"
else
  echo "[INFO] Skipping INT8_iGEMM_MF8 in quick-check (set INCLUDE_MF8=1 to force run)."
fi
check_family "IME" "${BASE_DIR}/IME_KERNEL_8x8_WITH_RVV_FALLBACK" "ime_kernel_8x8_zvl128b_lmul*_unroll*"
