...
/*
RVV IME KERNEL
Variant: ime_kernel_8x8_zvl128b_lmulmf2_unroll4
Settings:
 LMUL=1/2 (mf2)
 M=8
 N=8
 ...
 Kernel Name: ime_kernel_8x8_zvl128b_lmulmf2_unroll4
*/
#define _GNU_SOURCE
...
int igemm_kernel_8x8_zvl128b_lmulmf2_unroll4_i8i32(
...
static int rvv_fallback_gemm_s8s8(BLASLONG M, BLASLONG N, BLASLONG K,
                                  ...
                                  int32_t *C,
                                  BLASLONG ldc) {
    int rc = igemm_kernel_8x8_zvl128b_lmulmf2_unroll4_i8i32(M, N, K, alpha, (int8_t *)A, (int8_t *)B, C, ldc);
    if (rc == 0) return 0;
...
static void ime_kernel_8x8_acc(BLASLONG K_main, int32_t alpha,
    ...
    __asm__ __volatile__(
        ...
        : [kgroups] "r"(K_groups),
          ...
          [o2] "r"(out2),
          [o3] "r"(out3)
        : "t0", "t1", "t2", "t3", "t5", "memory",
          "v8", "v9", "v10", "v11", "v12", "v13", "v14", "v15",
          "v16", "v17", "v18", "v19", "v20", "v25");
}
...
int ime_kernel_8x8_zvl128b_lmulmf2_unroll4(
