...
/*
RVV IME KERNEL
Variant: ime_kernel_8x8_zvl128b_lmulmf2_unroll8
Settings:
 LMUL=1/2 (mf2)
 M=8
 N=8
 ...
 Kernel Name: ime_kernel_8x8_zvl128b_lmulmf2_unroll8
*/
#define _GNU_SOURCE
...
int igemm_kernel_8x8_zvl128b_lmulmf2_unroll8_i8i32(
...
static int rvv_fallback_gemm_s8s8(BLASLONG M, BLASLONG N, BLASLONG K,
                                  ...
                                  int32_t *C,
                                  BLASLONG ldc) {
    int rc = igemm_kernel_8x8_zvl128b_lmulmf2_unroll8_i8i32(M, N, K, alpha, (int8_t *)A, (int8_t *)B, C, ldc);
    if (rc == 0) return 0;
...
int ime_kernel_8x8_zvl128b_lmulmf2_unroll8(
