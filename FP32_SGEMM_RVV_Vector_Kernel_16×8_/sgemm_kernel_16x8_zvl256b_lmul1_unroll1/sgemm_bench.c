...
/* Kernel declaration - MUST match the function name in your kernel file */
int sgemm_kernel_16x8_zvl128b(
...
int main(int argc, char** argv)
{
    ...
    // 64-byte alignment is optimal for RVV
    ...
    // Execute the kernel
    sgemm_kernel_16x8_zvl128b(M, N, K, 1.0f, A, B, C, M);
