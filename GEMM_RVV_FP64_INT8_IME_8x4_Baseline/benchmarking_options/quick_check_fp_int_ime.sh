...
check_family "FP64" "${BASE_DIR}/FP64_Double_dgemm_kernel_8x4" "dgemm_kernel_8x4_zvl128b_lmul*_unroll*"
check_family "INT8_iGEMM" "${BASE_DIR}/igemm_rvv_8x4_i8i32" "igemm_kernel_8x4_zvl128b_lmul[1248]_unroll*"
check_family "INT8_iGEMM_MF2" "${BASE_DIR}/igemm_rvv_8x4_i8i32" "igemm_kernel_8x4_zvl128b_lmulmf2_unroll*"
check_family "INT8_iGEMM_MF4" "${BASE_DIR}/igemm_rvv_8x4_i8i32" "igemm_kernel_8x4_zvl128b_lmulmf4_unroll*"
check_family "INT8_iGEMM_MF8" "${BASE_DIR}/igemm_rvv_8x4_i8i32" "igemm_kernel_8x4_zvl128b_lmulmf8_unroll*"
check_family "IME_INT8_RVV_SCALAR_FALLBACK" "${BASE_DIR}/IME_KERNEL_8x4_WITH_RVV_AND_SCALAR_FALLBACK" "ime_kernel_8x4_zvl128b_*_unroll*"
