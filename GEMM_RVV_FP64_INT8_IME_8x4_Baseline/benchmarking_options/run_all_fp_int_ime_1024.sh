...
run_family "FP64" "${FP64_ROOT}" "dgemm_kernel_8x4_zvl128b_lmul*_unroll*"
...
MERGED_FILE="${OUT_DIR}/all_fp_int_ime_square_${M}_runs${RUNS}.log"
{
  ...
  for f in "${OUT_DIR}"/*_square_results.log; do
    ...
    case "${bn}" in
      ...
      dgemm_kernel_8x4_zvl128b_lmul*_unroll*_square_results.log|\
      dgemm_kernel_8x4_zvl128b_lmul*_unroll*_*_square_results.log|\
      igemm_kernel_8x4_zvl128b_lmul*_unroll*_square_results.log|\
      igemm_kernel_8x4_zvl128b_lmul*_unroll*_*_square_results.log|\
      ime_kernel_8x4_zvl128b_*_unroll*_square_results.log|\
      ime_kernel_8x4_zvl128b_*_unroll*_*_square_results.log)
        ;;
      *)
        continue
        ;;
