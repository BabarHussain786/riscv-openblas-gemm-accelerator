...
/*
RVV IME KERNEL
Variant: ime_kernel_8x4_zvl128b_lmul1_unroll8
Settings:
 LMUL=1 (m1)
 M=8
 N=4
 ...
 Kernel Name: ime_kernel_8x4_zvl128b_lmul1_unroll8
*/
#define _GNU_SOURCE
    ...
    const int8_t *A, const int8_t *B, int32_t *C, BLASLONG ldc)
{
    ...
    rc = igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32(M, N, K, alpha, A_rvv, B_rvv, C, ldc);
    free(A_rvv);
    free(B_rvv);
