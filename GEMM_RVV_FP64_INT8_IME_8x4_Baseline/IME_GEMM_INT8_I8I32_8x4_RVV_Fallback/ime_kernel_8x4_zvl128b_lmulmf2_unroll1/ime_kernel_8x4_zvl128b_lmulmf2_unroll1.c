...
/*
RVV IME KERNEL
Variant: ime_kernel_8x4_zvl128b_lmulmf2_unroll1
Settings:
 LMUL=1/2 (mf2)
 M=8
 N=4
 ...
 Kernel Name: ime_kernel_8x4_zvl128b_lmulmf2_unroll1
*/
#define _GNU_SOURCE
    ...
    const int8_t *A, const int8_t *B, int32_t *C, BLASLONG ldc)
{
    ...
    rc = igemm_kernel_8x4_zvl128b_lmulmf2_unroll1_i8i32(M, N, K, alpha, A_rvv, B_rvv, C, ldc);
    free(A_rvv);
    free(B_rvv);
...
int ime_kernel_8x4_zvl128b_lmulmf2_unroll1(
