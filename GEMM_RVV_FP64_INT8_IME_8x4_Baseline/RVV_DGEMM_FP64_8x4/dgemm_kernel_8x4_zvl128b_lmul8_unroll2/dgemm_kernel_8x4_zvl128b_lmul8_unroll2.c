...
/*
RVV FP KERNEL
Variant: dgemm_kernel_8x4_zvl128b_lmul8_unroll2
Settings:
 LMUL=8 (m8)
 M=8
 N=4
 ...
 Kernel Name: dgemm_kernel_8x4_zvl128b_lmul8_unroll2
*/
...
int dgemm_kernel_8x4_zvl128b_lmul8_unroll2(BLASLONG M, BLASLONG N, BLASLONG K, FLOAT alpha, FLOAT *A, FLOAT *B, FLOAT *C, BLASLONG ldc)
{
    BLASLONG gvl = 0;
    BLASLONG m_top = 0;
    BLASLONG n_top = 0;
