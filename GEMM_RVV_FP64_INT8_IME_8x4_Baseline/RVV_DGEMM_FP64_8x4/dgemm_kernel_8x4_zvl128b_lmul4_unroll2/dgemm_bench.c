...
/* Explicitly declare the unroll2 kernel */
int dgemm_kernel_8x4_zvl128b_lmul4_unroll2(
...
int main(int argc, char** argv)
{
    ...
    // Call the specific unroll 2 kernel
    int rc =     dgemm_kernel_8x4_zvl128b_lmul4_unroll2(M, N, K, 1.0, A, B, C, M);
    double t1 = now_sec();
