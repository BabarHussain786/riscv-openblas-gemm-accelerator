...
/* Kernel declaration */
int dgemm_kernel_8x4_zvl128b_lmul4_unroll1(
...
int main(int argc, char** argv)
{
    ...
    // Allocate 64-byte aligned memory for double precision arrays
    ...
    // Call the double precision kernel
    int rc =     dgemm_kernel_8x4_zvl128b_lmul4_unroll1(M, N, K, 1.0, A, B, C, M);
    double t1 = now_sec();
