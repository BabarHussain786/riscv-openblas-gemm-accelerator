...
// Updated function signature for lmul2 unroll4
int igemm_kernel_8x4_zvl128b_lmul2_unroll4_i8i32(
...
int main(int argc, char** argv)
{
    ...
    // Call the new kernel
    int rc = igemm_kernel_8x4_zvl128b_lmul2_unroll4_i8i32(M, N, K, 1, A, B, C, M);
