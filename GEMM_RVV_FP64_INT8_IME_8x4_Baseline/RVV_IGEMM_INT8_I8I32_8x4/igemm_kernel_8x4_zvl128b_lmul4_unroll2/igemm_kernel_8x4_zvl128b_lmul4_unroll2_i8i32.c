...
/*
RVV INT KERNEL
Variant: igemm_kernel_8x4_zvl128b_lmul4_unroll2_i8i32
Settings:
 input_LMUL=4 (m4)
 M=8
 N=4
 ...
 unroll_factor=2
 Kernel Name: igemm_kernel_8x4_zvl128b_lmul4_unroll2_i8i32

 Legality note:
 A true vector-widened m4 INT8 -> INT32 path would exceed the RVV maximum
 accumulator LMUL. This implementation keeps the variant honest by using true
 e8,m4 vector loads and scalar INT32 accumulation.
*/
#include <stddef.h>
#include <stdint.h>
...
#define INPUT_VSETVL(n) __riscv_vsetvl_e8m4(n)
typedef vint8m4_t input_i8_t;
...
int igemm_kernel_8x4_zvl128b_lmul4_unroll2_i8i32(
