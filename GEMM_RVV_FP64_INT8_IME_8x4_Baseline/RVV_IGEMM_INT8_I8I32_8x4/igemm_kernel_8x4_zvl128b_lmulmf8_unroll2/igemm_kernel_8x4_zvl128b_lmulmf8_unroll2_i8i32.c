...
/*
RVV INT KERNEL
Variant: igemm_kernel_8x4_zvl128b_lmulmf8_unroll2_i8i32
Settings:
 input_LMUL=1/8 (mf8)
 widening_chain=INT8 LMUL 1/8 -> INT16 LMUL 1/4 -> INT32 LMUL 1/2
 M=8
 N=4
 precision=int8 x int8 -> int32
 unroll_factor=2
 Kernel Name: igemm_kernel_8x4_zvl128b_lmulmf8_unroll2_i8i32
*/
#include <stddef.h>
#include <stdint.h>
...
#define INPUT_VSETVL(n) __riscv_vsetvl_e8mf8(n)
typedef vint8mf8_t input_i8_t;
typedef vint16mf4_t wide_i16_t;
typedef vint32mf2_t acc_i32_t;
#define INPUT_VLE8(p, vl) __riscv_vle8_v_i8mf8(p, vl)
#define WIDEN_I16(v, vl) __riscv_vsext_vf2_i16mf4(v, vl)
#define ACC_ZERO(vl) __riscv_vmv_v_x_i32mf2(0, vl)
#define ACC_WMACC(acc, b, a, vl) __riscv_vwmacc_vx_i32mf2(acc, b, a, vl)
#define ACC_STORE(p, v, vl) __riscv_vse32_v_i32mf2(p, v, vl)
...
int igemm_kernel_8x4_zvl128b_lmulmf8_unroll2_i8i32(
