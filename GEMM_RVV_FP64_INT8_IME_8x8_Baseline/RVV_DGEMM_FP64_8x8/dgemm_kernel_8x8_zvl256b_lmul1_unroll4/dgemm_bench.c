...
// Prototype for the 8x8 zvl256b unroll 4 kernel
int dgemm_kernel_8x8_zvl256b_lmul1_unroll4(
...
int main(int argc, char** argv)
{
    ...
    // Call the 8x8 unroll 4 kernel
    int rc = dgemm_kernel_8x8_zvl256b_lmul1_unroll4(M, N, K, 1.0, A, B, C, M);
