...
/*
RVV FP KERNEL
Variant: dgemm_kernel_8x8_zvl256b_lmul1_unroll1
Settings:
 LMUL=1 (m1)
 M=8
 N=8
 ...
 Kernel Name: dgemm_kernel_8x8_zvl256b_lmul1_unroll1
*/
...
int dgemm_kernel_8x8_zvl256b_lmul1_unroll1(BLASLONG M, BLASLONG N, BLASLONG K, FLOAT alpha, FLOAT* A, FLOAT* B, FLOAT* C, BLASLONG ldc)
{
    BLASLONG gvl = 0;
    BLASLONG m_top = 0;
    BLASLONG n_top = 0;
    ...
    for (BLASLONG j=0; j<N/8; j+=1) {
        ...
        for (BLASLONG i=0; i<M/8; i+=1) {
            ...
            vfloat64m1_t A0 = __riscv_vle64_v_f64m1( &A[ai], gvl );
            ai += 8;
            ...
            for(BLASLONG k=1; k<K; k++) {
                ...
                A0 = __riscv_vle64_v_f64m1( &A[ai], gvl );
                ai += 8;
            ...
            vfloat64m1_t c0 = __riscv_vle64_v_f64m1( &C[ci], gvl); ci += ldc;
            vfloat64m1_t c1 = __riscv_vle64_v_f64m1( &C[ci], gvl); ci += ldc;
            vfloat64m1_t c2 = __riscv_vle64_v_f64m1( &C[ci], gvl); ci += ldc;
            vfloat64m1_t c3 = __riscv_vle64_v_f64m1( &C[ci], gvl); ci += ldc;
            vfloat64m1_t c4 = __riscv_vle64_v_f64m1( &C[ci], gvl); ci += ldc;
            vfloat64m1_t c5 = __riscv_vle64_v_f64m1( &C[ci], gvl); ci += ldc;
            vfloat64m1_t c6 = __riscv_vle64_v_f64m1( &C[ci], gvl); ci += ldc;
            ...
            __riscv_vse64_v_f64m1( &C[ci], c0, gvl); ci += ldc;
            __riscv_vse64_v_f64m1( &C[ci], c1, gvl); ci += ldc;
            __riscv_vse64_v_f64m1( &C[ci], c2, gvl); ci += ldc;
            __riscv_vse64_v_f64m1( &C[ci], c3, gvl); ci += ldc;
            __riscv_vse64_v_f64m1( &C[ci], c4, gvl); ci += ldc;
            __riscv_vse64_v_f64m1( &C[ci], c5, gvl); ci += ldc;
            __riscv_vse64_v_f64m1( &C[ci], c6, gvl); ci += ldc;
