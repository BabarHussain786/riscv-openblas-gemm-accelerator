...
/*
RVV FP KERNEL
Variant: dgemm_kernel_8x8_zvl128b_lmul4_unroll4
Settings:
 LMUL=4 (m4)
 M=8
 N=8
 ...
 Kernel Name: dgemm_kernel_8x8_zvl128b_lmul4_unroll4
*/
...
int dgemm_kernel_8x8_zvl128b_lmul4_unroll4(BLASLONG M, BLASLONG N, BLASLONG K, FLOAT alpha, FLOAT* A, FLOAT* B, FLOAT* C, BLASLONG ldc)
{
    BLASLONG gvl = 0;
    BLASLONG m_top = 0;
    BLASLONG n_top = 0;
    ...
    for (BLASLONG j=0; j<N/8; j+=1) {
        ...
        for (BLASLONG i=0; i<M/8; i+=1) {
            ...
            vfloat64m4_t A0 = __riscv_vle64_v_f64m4( &A[ai], gvl );
            ai += 8;
            ...
            vfloat64m4_t result4 = __riscv_vfmul_vf_f64m4( A0, B4, gvl);
            vfloat64m4_t result5 = __riscv_vfmul_vf_f64m4( A0, B5, gvl);
            vfloat64m4_t result6 = __riscv_vfmul_vf_f64m4( A0, B6, gvl);
            vfloat64m4_t result7 = __riscv_vfmul_vf_f64m4( A0, B7, gvl);
            ...
            for(BLASLONG k=1; k<K; k++) {
                ...
                A0 = __riscv_vle64_v_f64m4( &A[ai], gvl );
                ai += 8;
                ...
                result4 = __riscv_vfmacc_vf_f64m4( result4, B4, A0, gvl);
                result5 = __riscv_vfmacc_vf_f64m4( result5, B5, A0, gvl);
                result6 = __riscv_vfmacc_vf_f64m4( result6, B6, A0, gvl);
                result7 = __riscv_vfmacc_vf_f64m4( result7, B7, A0, gvl);
            }

            BLASLONG ci=n_top*ldc+m_top;

            vfloat64m4_t c0 = __riscv_vle64_v_f64m4( &C[ci], gvl); ci += ldc;
            vfloat64m4_t c1 = __riscv_vle64_v_f64m4( &C[ci], gvl); ci += ldc;
            vfloat64m4_t c2 = __riscv_vle64_v_f64m4( &C[ci], gvl); ci += ldc;
            vfloat64m4_t c3 = __riscv_vle64_v_f64m4( &C[ci], gvl); ci += ldc;
            vfloat64m4_t c4 = __riscv_vle64_v_f64m4( &C[ci], gvl); ci += ldc;
            vfloat64m4_t c5 = __riscv_vle64_v_f64m4( &C[ci], gvl); ci += ldc;
            vfloat64m4_t c6 = __riscv_vle64_v_f64m4( &C[ci], gvl); ci += ldc;
            vfloat64m4_t c7 = __riscv_vle64_v_f64m4( &C[ci], gvl);
            ...
            c4 = __riscv_vfmacc_vf_f64m4( c4, alpha, result4, gvl );
            c5 = __riscv_vfmacc_vf_f64m4( c5, alpha, result5, gvl );
            c6 = __riscv_vfmacc_vf_f64m4( c6, alpha, result6, gvl );
            c7 = __riscv_vfmacc_vf_f64m4( c7, alpha, result7, gvl );

            ci=n_top*ldc+m_top;

            __riscv_vse64_v_f64m4( &C[ci], c0, gvl); ci += ldc;
            __riscv_vse64_v_f64m4( &C[ci], c1, gvl); ci += ldc;
            __riscv_vse64_v_f64m4( &C[ci], c2, gvl); ci += ldc;
            __riscv_vse64_v_f64m4( &C[ci], c3, gvl); ci += ldc;
            __riscv_vse64_v_f64m4( &C[ci], c4, gvl); ci += ldc;
            __riscv_vse64_v_f64m4( &C[ci], c5, gvl); ci += ldc;
            __riscv_vse64_v_f64m4( &C[ci], c6, gvl); ci += ldc;
            __riscv_vse64_v_f64m4( &C[ci], c7, gvl);
            m_top += 8;
        }
