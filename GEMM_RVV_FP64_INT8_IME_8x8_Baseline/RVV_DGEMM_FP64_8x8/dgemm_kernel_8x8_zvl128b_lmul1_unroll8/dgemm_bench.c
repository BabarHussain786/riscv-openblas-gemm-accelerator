...
// Prototype for the 8x8 zvl128b unroll 8 kernel
int dgemm_kernel_8x8_zvl128b_lmul1_unroll8(
...
int main(int argc, char** argv)
{
    ...
    int rc = dgemm_kernel_8x8_zvl128b_lmul1_unroll8(M, N, K, 1.0, A, B, C, M);
