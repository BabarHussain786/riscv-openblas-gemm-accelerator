...
// Prototype for the 8x8 zvl256b unroll 8 kernel
int dgemm_kernel_8x8_zvl256b_lmul1_unroll8(
...
int main(int argc, char** argv)
{
    ...
    // Call the 8x8 unroll 8 kernel
    int rc = dgemm_kernel_8x8_zvl256b_lmul1_unroll8(M, N, K, 1.0, A, B, C, M);
