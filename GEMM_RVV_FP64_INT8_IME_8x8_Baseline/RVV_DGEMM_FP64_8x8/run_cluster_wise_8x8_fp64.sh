...
echo "=========================================================="
echo " Running FP64 8x8 Benchmarks on BOTH Clusters"
...
DIRS=(
    "dgemm_kernel_8x8_zvl256b_lmul1_unroll1"
    "dgemm_kernel_8x8_zvl256b_lmul1_unroll2"
    "dgemm_kernel_8x8_zvl256b_lmul1_unroll4"
    "dgemm_kernel_8x8_zvl256b_lmul1_unroll8"
    "dgemm_kernel_8x8_zvl256b_lmul2_unroll1"
    "dgemm_kernel_8x8_zvl256b_lmul2_unroll2"
    "dgemm_kernel_8x8_zvl256b_lmul2_unroll4"
    "dgemm_kernel_8x8_zvl256b_lmul2_unroll8"
    "dgemm_kernel_8x8_zvl256b_lmul4_unroll1"
    "dgemm_kernel_8x8_zvl256b_lmul4_unroll2"
    "dgemm_kernel_8x8_zvl256b_lmul4_unroll4"
    "dgemm_kernel_8x8_zvl256b_lmul4_unroll8"
    "dgemm_kernel_8x8_zvl256b_lmul8_unroll1"
    "dgemm_kernel_8x8_zvl256b_lmul8_unroll2"
    "dgemm_kernel_8x8_zvl256b_lmul8_unroll4"
    "dgemm_kernel_8x8_zvl256b_lmul8_unroll8"
)
...
echo "----------------------------------------------------------"
echo "ALL FULL-CLUSTER FP64 8x8 BENCHMARKS COMPLETE!"
echo "=========================================================="
