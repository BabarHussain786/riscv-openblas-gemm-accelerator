...
// Explicitly mapped to the unroll8 filename convention
int dgemm_kernel_8x8_zvl256b_lmul8_unroll8(
...
int main(int argc, char** argv)
{
    ...
    int rc = dgemm_kernel_8x8_zvl256b_lmul8_unroll8(M, N, K, 1.0, A, B, C, M);
