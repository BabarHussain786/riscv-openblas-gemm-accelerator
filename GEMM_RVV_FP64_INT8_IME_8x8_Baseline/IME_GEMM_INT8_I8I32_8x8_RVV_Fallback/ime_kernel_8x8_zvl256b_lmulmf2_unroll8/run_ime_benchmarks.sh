...
LOGFILE="benchmark_ime_kernel_8x8_zvl256b_lmulmf2_unroll8_$(date +%Y%m%d_%H%M%S).log"

echo "======================================================" | tee "$LOGFILE"
echo "IME BENCHMARK (ime_kernel_8x8_zvl256b_lmulmf2_unroll8)" | tee -a "$LOGFILE"
