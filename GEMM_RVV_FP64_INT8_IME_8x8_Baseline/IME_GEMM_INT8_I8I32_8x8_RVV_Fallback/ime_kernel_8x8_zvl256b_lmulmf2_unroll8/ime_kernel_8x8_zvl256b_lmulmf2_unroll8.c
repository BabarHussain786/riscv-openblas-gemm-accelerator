...
/*
RVV IME KERNEL
Variant: ime_kernel_8x8_zvl256b_lmulmf2_unroll8
Settings:
 LMUL=1/2 (mf2)
 M=8
 N=8
 ...
 Kernel Name: ime_kernel_8x8_zvl256b_lmulmf2_unroll8
*/
#define _GNU_SOURCE
...
int igemm_kernel_8x8_zvl256b_lmulmf2_unroll8_i8i32(
...
static int rvv_fallback_gemm_s8s8(BLASLONG M, BLASLONG N, BLASLONG K,
    ...
    return igemm_kernel_8x8_zvl256b_lmulmf2_unroll8_i8i32(M, N, K, alpha, (GEMM_I8 *)A, (GEMM_I8 *)B, C, ldc);
#else
    (void)M;
    (void)N;
    (void)K;
...
static int ime_vector_shape_supported(void) {
    ...
    __asm__ __volatile__(
        "li t0,8\n\t"
        "vsetvli %0,t0,e32,mf2,ta,ma\n\t"
        "li t0,16\n\t"
        "vsetvli %1,t0,e8,mf2,ta,ma\n\t"
        "li t0,32\n\t"
        "vsetvli %2,t0,e8,mf2,ta,ma\n\t"
...
static int ime_gemm_s8s8_prepacked(BLASLONG M, BLASLONG N, BLASLONG K,
    ...
    if (!SPACEMIT_IME_HAS_RVV || !ime_vector_shape_supported() || K_main <= 0) {
        int rvv_rc = rvv_fallback_gemm_s8s8(M, N, K, alpha, A, B, C, ldc);
        if (rvv_rc == 0) return 0;
    } else {
...
int ime_kernel_8x8_zvl256b_lmulmf2_unroll8(
    BLASLONG M, BLASLONG N, BLASLONG K,
