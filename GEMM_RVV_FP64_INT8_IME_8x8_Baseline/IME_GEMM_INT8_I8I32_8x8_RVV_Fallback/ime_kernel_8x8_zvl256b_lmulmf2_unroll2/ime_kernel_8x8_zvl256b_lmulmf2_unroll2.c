...
/*
RVV IME KERNEL
Variant: ime_kernel_8x8_zvl256b_lmulmf2_unroll2
Settings:
 LMUL=1/2 (mf2)
 M=8
 N=8
 ...
 Kernel Name: ime_kernel_8x8_zvl256b_lmulmf2_unroll2
*/
#define _GNU_SOURCE
...
int igemm_kernel_8x8_zvl256b_lmulmf2_unroll2_i8i32(
...
static int rvv_fallback_gemm_s8s8(BLASLONG M, BLASLONG N, BLASLONG K,
    ...
    return igemm_kernel_8x8_zvl256b_lmulmf2_unroll2_i8i32(M, N, K, alpha, (GEMM_I8 *)A, (GEMM_I8 *)B, C, ldc);
#else
    (void)M;
    (void)N;
    (void)K;
...
int ime_kernel_8x8_zvl256b_lmulmf2_unroll2(
    BLASLONG M, BLASLONG N, BLASLONG K,
