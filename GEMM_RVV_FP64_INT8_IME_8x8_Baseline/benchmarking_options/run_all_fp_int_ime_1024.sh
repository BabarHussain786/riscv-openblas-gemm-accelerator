...
FP64_ROOT="${BASE_DIR}/FP64_Double_dgemm_kernel_8x8"
INT8_ROOT="${BASE_DIR}/igemm_rvv_8x8_i8i32"
INT8_MF2_ROOT="${BASE_DIR}/igemm_rvv_8x8_i8i32"
INT8_MF4_ROOT="${BASE_DIR}/igemm_rvv_8x8_i8i32"
INT8_MF8_ROOT="${BASE_DIR}/igemm_rvv_8x8_i8i32"
IME_ROOT="${BASE_DIR}/IME_KERNEL_8x8_WITH_RVV_AND_SCALAR_FALLBACK"
...
cleanup_old_logs() {
  ...
  rm -f "${OUT_DIR}"/dgemm_kernel_8x8_zvl256b_lmul*_unroll*_AI_*_square_results.log
  rm -f "${OUT_DIR}"/dgemm_kernel_8x8_zvl256b_lmul*_unroll*_GP_*_square_results.log
  rm -f "${OUT_DIR}"/igemm_kernel_8x8_zvl256b_lmul*_unroll*_AI_*_square_results.log
  rm -f "${OUT_DIR}"/igemm_kernel_8x8_zvl256b_lmul*_unroll*_GP_*_square_results.log
  rm -f "${OUT_DIR}"/ime_kernel_8x8_zvl256b_*_unroll*_AI_*_square_results.log
  rm -f "${OUT_DIR}"/ime_kernel_8x8_zvl256b_*_unroll*_GP_*_square_results.log
}
...
run_family "FP64" "${FP64_ROOT}" "dgemm_kernel_8x8_zvl256b_lmul*_unroll*" "GFLOPS:"
run_family "INT8_iGEMM_LMUL1" "${INT8_ROOT}" "igemm_kernel_8x8_zvl256b_lmul1_unroll*" "GOPS:"
run_family "INT8_iGEMM_LMUL2" "${INT8_ROOT}" "igemm_kernel_8x8_zvl256b_lmul2_unroll*" "GOPS:"
run_family "INT8_iGEMM_LMUL4" "${INT8_ROOT}" "igemm_kernel_8x8_zvl256b_lmul4_unroll*" "GOPS:"
run_family "INT8_iGEMM_LMUL8" "${INT8_ROOT}" "igemm_kernel_8x8_zvl256b_lmul8_unroll*" "GOPS:"
run_family "INT8_iGEMM_MF2" "${INT8_MF2_ROOT}" "igemm_kernel_8x8_zvl256b_lmulmf2_unroll*" "GOPS:"
run_family "INT8_iGEMM_MF4" "${INT8_MF4_ROOT}" "igemm_kernel_8x8_zvl256b_lmulmf4_unroll*" "GOPS:"
if [ "${INCLUDE_MF8}" = "1" ]; then
  run_family "INT8_iGEMM_MF8" "${INT8_MF8_ROOT}" "igemm_kernel_8x8_zvl256b_lmulmf8_unroll*" "GOPS:"
else
  echo "[INFO] Skipping INT8_iGEMM_MF8 (set INCLUDE_MF8=1 to force run)." | tee -a "${LIVE_LOG}"
fi
run_family "IME" "${IME_ROOT}" "ime_kernel_8x8_zvl256b_*_unroll*" "GOPS:"
...
MERGED_FILE="${OUT_DIR}/all_fp_int_ime_square_${M}_runs${RUNS}.log"
{
  ...
  for f in "${OUT_DIR}"/*_square_results.log; do
    ...
    case "${bn}" in
      ...
      dgemm_kernel_8x8_zvl256b_lmul*_unroll*_square_results.log|\
      dgemm_kernel_8x8_zvl256b_lmul*_unroll*_*_square_results.log|\
      igemm_kernel_8x8_zvl256b_lmul*_unroll*_square_results.log|\
      igemm_kernel_8x8_zvl256b_lmul*_unroll*_*_square_results.log|\
      ime_kernel_8x8_zvl256b_*_unroll*_square_results.log|\
      ime_kernel_8x8_zvl256b_*_unroll*_*_square_results.log)
        ;;
      *)
        continue
        ;;
