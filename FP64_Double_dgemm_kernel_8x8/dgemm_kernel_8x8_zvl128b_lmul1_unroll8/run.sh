...
LOGFILE="benchmark_dgemm_8x8_zvl256b_unroll8_$(date +%Y%m%d_%H%M%S).log"

echo "======================================================" | tee "$LOGFILE"
echo "RVV DGEMM BENCHMARK (FP64 8x8 - LMUL 1 - Unroll 8 - zvl256b)" | tee -a "$LOGFILE"
...
# Run standard 2048 square matrix
