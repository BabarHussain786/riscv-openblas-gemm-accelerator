	.file	"dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c"
	.option nopic
...
.LFB0:
	...
	mv	a7,a1	# N, tmp974
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:25:     for (BLASLONG j = 0; j < N / 4; j += 1) {
	srai	a1,a1,63	#, tmp725, N
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:18: {
	sd	s3,144(sp)	#,
	sd	s4,136(sp)	#,
	sd	s6,120(sp)	#,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:25:     for (BLASLONG j = 0; j < N / 4; j += 1) {
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:91:         if (M & 4) {
	andi	a2,a0,4	#, _46, M
	sd	a2,8(sp)	# _46, %sfp
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:153:         if (M & 2) {
	andi	a2,a0,2	#, _91, M
	sd	a2,16(sp)	# _91, %sfp
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:191:         if (M & 1) {
	andi	a2,a0,1	#, _178, M
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:184:             C[ci + 2 * ldc + 0] += alpha * result4;
	slli	a5,a6,1	#, _150, ldc
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:29:         for (BLASLONG i = 0; i < M / 8; i += 1) {
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:186:             C[ci + 3 * ldc + 0] += alpha * result6;
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:29:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	li	s11,7		# tmp744,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:47:             for (BLASLONG k = 1; k < K; k++) {
	li	t6,1		# tmp893,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:92:             gvl = __riscv_vsetvl_e64m2(4);
	sd	a7,64(sp)	# N, %sfp
	sd	a4,72(sp)	# B, %sfp
.L18:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:29:         for (BLASLONG i = 0; i < M / 8; i += 1) {
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:29:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	li	s9,0		# i,
.L8:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:38:             vfloat64m2_t A0 = __riscv_vle64_v_f64m2(&A[ai + 0 * gvl], gvl);
	vle64.v	v2,0(a7)	# A0,* ivtmp.463
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:41:             vfloat64m2_t result0 = __riscv_vfmul_vf_f64m2(A0, B0, gvl);
	fld	fa2,-32(a1)	# MEM[(FLOAT *)_1631 + -32B], MEM[(FLOAT *)_1631 + -32B]
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:33:             double B1 = B[bi + 1];
	fld	fa3,-24(a1)	# B1, MEM[(FLOAT *)_1631 + -24B]
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:34:             double B2 = B[bi + 2];
	fld	fa4,-16(a1)	# B2, MEM[(FLOAT *)_1631 + -16B]
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:35:             double B3 = B[bi + 3];
	fld	fa5,-8(a1)	# B3, MEM[(FLOAT *)_1631 + -8B]
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:41:             vfloat64m2_t result0 = __riscv_vfmul_vf_f64m2(A0, B0, gvl);
	vfmul.vf	v6,v2,fa2	# result0, A0, MEM[(FLOAT *)_1631 + -32B],
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:42:             vfloat64m2_t result1 = __riscv_vfmul_vf_f64m2(A0, B1, gvl);
	vfmul.vf	v8,v2,fa3	# result1, A0, B1,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:43:             vfloat64m2_t result2 = __riscv_vfmul_vf_f64m2(A0, B2, gvl);
	vfmul.vf	v10,v2,fa4	# result2, A0, B2,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:44:             vfloat64m2_t result3 = __riscv_vfmul_vf_f64m2(A0, B3, gvl);
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:54:                 A0 = __riscv_vle64_v_f64m2(&A[ai + 0 * gvl], gvl);
	vle64.v	v4,0(a2)	# A0,* ivtmp.456
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:57:                 result0 = __riscv_vfmacc_vf_f64m2(result0, B0, A0, gvl);
	fld	fa2,0(a1)	# MEM[(FLOAT *)_1698], MEM[(FLOAT *)_1698]
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:49:                 B1 = B[bi + 1];
	fld	fa3,8(a1)	# B1, MEM[(FLOAT *)_1698 + 8B]
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:50:                 B2 = B[bi + 2];
	fld	fa4,16(a1)	# B2, MEM[(FLOAT *)_1698 + 16B]
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:51:                 B3 = B[bi + 3];
	fld	fa5,24(a1)	# B3, MEM[(FLOAT *)_1698 + 24B]
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:47:             for (BLASLONG k = 1; k < K; k++) {
	addi	a4,a1,32	#, ivtmp.454, ivtmp.482
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:57:                 result0 = __riscv_vfmacc_vf_f64m2(result0, B0, A0, gvl);
	vfmacc.vf	v6,fa2,v4	# result0, MEM[(FLOAT *)_1698], A0,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:58:                 result1 = __riscv_vfmacc_vf_f64m2(result1, B1, A0, gvl);
	vfmacc.vf	v8,fa3,v4	# result1, B1, A0,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:59:                 result2 = __riscv_vfmacc_vf_f64m2(result2, B2, A0, gvl);
	vfmacc.vf	v10,fa4,v4	# result2, B2, A0,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:60:                 result3 = __riscv_vfmacc_vf_f64m2(result3, B3, A0, gvl);
	vfmacc.vf	v2,fa5,v4	# result3, B3, A0,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:47:             for (BLASLONG k = 1; k < K; k++) {
...
.L6:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:65:             vfloat64m2_t c0 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	vle64.v	v14,0(a6)	# c0,* ivtmp.464
	add	a2,t1,a6	# ivtmp.464, _1671, _1672
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:67:             vfloat64m2_t c1 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	vle64.v	v12,0(a2)	# c1,* _1671
	add	a4,a2,t1	# _1672, _1668, _1671
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:71:             vfloat64m2_t c3 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	add	a0,a4,t1	# _1672, _44, _1668
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:71:             vfloat64m2_t c3 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	vle64.v	v4,0(a0)	# c3,* _44
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:72:             c0 = __riscv_vfmacc_vf_f64m2(c0, alpha, result0, gvl);
	vfmacc.vf	v14,fa1,v6	# c0, alpha, result0,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:69:             vfloat64m2_t c2 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	vle64.v	v6,0(a4)	# c2,* _1668
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:73:             c1 = __riscv_vfmacc_vf_f64m2(c1, alpha, result1, gvl);
	vfmacc.vf	v12,fa1,v8	# c1, alpha, result1,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:29:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	addi	s9,s9,1	#, i, i
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:29:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	add	a7,a7,t0	# _1684, ivtmp.463, ivtmp.463
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:75:             c3 = __riscv_vfmacc_vf_f64m2(c3, alpha, result3, gvl);
	vfmacc.vf	v4,fa1,v2	# c3, alpha, result3,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:79:             __riscv_vse64_v_f64m2(&C[ci], c0, gvl);
	vse64.v	v14,0(a6)	# c0,* ivtmp.464,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:74:             c2 = __riscv_vfmacc_vf_f64m2(c2, alpha, result2, gvl);
	vfmacc.vf	v6,fa1,v10	# c2, alpha, result2,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:29:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	addi	a6,a6,64	#, ivtmp.464, ivtmp.464
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:81:             __riscv_vse64_v_f64m2(&C[ci], c1, gvl);
	vse64.v	v12,0(a2)	# c1,* _1671,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:83:             __riscv_vse64_v_f64m2(&C[ci], c2, gvl);
	vse64.v	v6,0(a4)	# c2,* _1668,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:85:             __riscv_vse64_v_f64m2(&C[ci], c3, gvl);
...
.L2:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:222:     if (N & 2) {
	andi	a5,a7,2	#, _234, N
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:222:     if (N & 2) {
	beq	a5,zero,.L311	#, _234,,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:226:         for (BLASLONG i = 0; i < M / 8; i += 1) {
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:228:             BLASLONG bi = n_top * K;
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:226:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	li	t6,0		# i,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:240:             for (BLASLONG k = 1; k < K; k++) {
	li	s2,1		# tmp808,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:252:             BLASLONG ci = n_top * ldc + m_top;
	mul	a0,s0,s6	# _549, n_top, ldc
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:229:             double B0 = B[bi + 0];
	slli	t0,a3,3	#, _237, bi.110_236
	addi	t5,a3,2	#, _810, bi.110_236
	add	t1,t1,a3	# bi.110_236, _350, _348
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:230:             double B1 = B[bi + 1];
...
.L23:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:233:             vfloat64m2_t A0 = __riscv_vle64_v_f64m2(&A[ai + 0 * gvl], gvl);
	vle64.v	v2,0(t3)	# A0,* ivtmp.422
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:236:             vfloat64m2_t result0 = __riscv_vfmul_vf_f64m2(A0, B0, gvl);
	fld	fa4,0(t0)	# *_238, *_238
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:230:             double B1 = B[bi + 1];
	fld	fa5,0(s1)	# B1, *_241
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:236:             vfloat64m2_t result0 = __riscv_vfmul_vf_f64m2(A0, B0, gvl);
	vfmul.vf	v4,v2,fa4	# result0, A0, *_238,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:237:             vfloat64m2_t result1 = __riscv_vfmul_vf_f64m2(A0, B1, gvl);
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:245:                 A0 = __riscv_vle64_v_f64m2(&A[ai + 0 * gvl], gvl);
	vle64.v	v6,0(a3)	# A0,* ivtmp.412
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:248:                 result0 = __riscv_vfmacc_vf_f64m2(result0, B0, A0, gvl);
	fld	fa4,0(t5)	# MEM[(FLOAT *)_346], MEM[(FLOAT *)_346]
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:242:                 B1 = B[bi + 1];
	fld	fa5,8(t5)	# B1, MEM[(FLOAT *)_346 + 8B]
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:240:             for (BLASLONG k = 1; k < K; k++) {
	addi	a2,t5,16	#, ivtmp.410, ivtmp.410
	addi	a3,t3,128	#, ivtmp.412, ivtmp.422
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:248:                 result0 = __riscv_vfmacc_vf_f64m2(result0, B0, A0, gvl);
	vfmacc.vf	v4,fa4,v6	# result0, MEM[(FLOAT *)_346], A0,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:249:                 result1 = __riscv_vfmacc_vf_f64m2(result1, B1, A0, gvl);
...
.L21:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:254:             vfloat64m2_t c0 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	vle64.v	v8,0(a0)	# c0,* ivtmp.423
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:256:             vfloat64m2_t c1 = __riscv_vle64_v_f64m2(&C[ci], gvl);
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:257:             c0 = __riscv_vfmacc_vf_f64m2(c0, alpha, result0, gvl);
	vfmacc.vf	v8,fa1,v4	# c0, alpha, result0,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:258:             c1 = __riscv_vfmacc_vf_f64m2(c1, alpha, result1, gvl);
	vfmacc.vf	v6,fa1,v2	# c1, alpha, result1,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:262:             __riscv_vse64_v_f64m2(&C[ci], c0, gvl);
	vse64.v	v8,0(a0)	# c0,* ivtmp.423,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:226:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	addi	a0,a0,64	#, ivtmp.423, ivtmp.423
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:264:             __riscv_vse64_v_f64m2(&C[ci], c1, gvl);
	vse64.v	v6,0(a3)	# c1,* _260,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:226:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	blt	t6,a6,.L23	#, i, _887,
	slli	a6,a6,3	#, m_top, _887
.L20:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:268:         if (M & 4) {
	andi	a5,s4,4	#, _262, M
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:268:         if (M & 4) {
	beq	a5,zero,.L24	#, _262,,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:271:             BLASLONG ai = m_top * K;
	mul	a3,t4,a6	# ai, K, m_top
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:269:             gvl = __riscv_vsetvl_e64m2(4);
	vsetivli	zero,4,e64,m2,ta,ma	#,,,,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:284:             for (BLASLONG k = 1; k < K; k++) {
	li	t1,1		# tmp816,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:272:             BLASLONG bi = n_top * K;
	mul	a1,t4,s0	# bi, K, n_top
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:277:             vfloat64m2_t A0 = __riscv_vle64_v_f64m2(&A[ai + 0 * gvl], gvl);
	slli	a2,a3,3	#, _271, ai
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:277:             vfloat64m2_t A0 = __riscv_vle64_v_f64m2(&A[ai + 0 * gvl], gvl);
	add	a2,s3,a2	# _271, _272, A
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:277:             vfloat64m2_t A0 = __riscv_vle64_v_f64m2(&A[ai + 0 * gvl], gvl);
	vle64.v	v2,0(a2)	# A0,* _272
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:278:             ai += 4;
	addi	a3,a3,4	#, ai, ai
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:273:             double B0 = B[bi + 0];
	slli	a2,a1,3	#, _265, bi
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:274:             double B1 = B[bi + 1];
	add	a2,a4,a2	# _265, tmp811, B
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:280:             vfloat64m2_t result0 = __riscv_vfmul_vf_f64m2(A0, B0, gvl);
	fld	fa4,0(a2)	# *_266, *_266
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:274:             double B1 = B[bi + 1];
	fld	fa5,8(a2)	# B1, *_269
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:275:             bi += 2;
	addi	a2,a1,2	#, bi, bi
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:280:             vfloat64m2_t result0 = __riscv_vfmul_vf_f64m2(A0, B0, gvl);
	vfmul.vf	v4,v2,fa4	# result0, A0, *_266,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:281:             vfloat64m2_t result1 = __riscv_vfmul_vf_f64m2(A0, B1, gvl);
	vfmul.vf	v2,v2,fa5	# result1, A0, B1,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:284:             for (BLASLONG k = 1; k < K; k++) {
...
.L243:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:289:                 A0 = __riscv_vle64_v_f64m2(&A[ai + 0 * gvl], gvl);
	vle64.v	v6,0(a3)	# A0,* ivtmp.395
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:292:                 result0 = __riscv_vfmacc_vf_f64m2(result0, B0, A0, gvl);
	fld	fa4,0(a2)	# MEM[(FLOAT *)_409], MEM[(FLOAT *)_409]
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:286:                 B1 = B[bi + 1];
	fld	fa5,8(a2)	# B1, MEM[(FLOAT *)_409 + 8B]
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:284:             for (BLASLONG k = 1; k < K; k++) {
	addi	a3,a3,32	#, ivtmp.395, ivtmp.395
	addi	a2,a2,16	#, ivtmp.393, ivtmp.393
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:292:                 result0 = __riscv_vfmacc_vf_f64m2(result0, B0, A0, gvl);
	vfmacc.vf	v4,fa4,v6	# result0, MEM[(FLOAT *)_409], A0,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:293:                 result1 = __riscv_vfmacc_vf_f64m2(result1, B1, A0, gvl);
	vfmacc.vf	v2,fa5,v6	# result1, B1, A0,
.L242:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:289:                 A0 = __riscv_vle64_v_f64m2(&A[ai + 0 * gvl], gvl);
	vle64.v	v6,0(a3)	# A0,* ivtmp.395
...
.L25:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:296:             BLASLONG ci = n_top * ldc + m_top;
	mul	a3,s6,s0	# _282, ldc, n_top
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:296:             BLASLONG ci = n_top * ldc + m_top;
	add	a3,a3,a6	# m_top, ci, _282
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:298:             vfloat64m2_t c0 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	slli	a2,a3,3	#, _284, ci
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:298:             vfloat64m2_t c0 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	add	a2,t2,a2	# _284, _285, C
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:298:             vfloat64m2_t c0 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	vle64.v	v8,0(a2)	# c0,* _285
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:299:             ci += ldc - gvl * 0;
	add	a3,s6,a3	# ci, ci_575, ldc
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:300:             vfloat64m2_t c1 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	slli	a3,a3,3	#, _287, ci_575
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:300:             vfloat64m2_t c1 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	add	a3,t2,a3	# _287, _288, C
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:300:             vfloat64m2_t c1 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	vle64.v	v6,0(a3)	# c1,* _288
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:309:             m_top += 4;
	addi	a6,a6,4	#, m_top, m_top
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:301:             c0 = __riscv_vfmacc_vf_f64m2(c0, alpha, result0, gvl);
	vfmacc.vf	v8,fa1,v4	# c0, alpha, result0,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:302:             c1 = __riscv_vfmacc_vf_f64m2(c1, alpha, result1, gvl);
	vfmacc.vf	v6,fa1,v2	# c1, alpha, result1,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:306:             __riscv_vse64_v_f64m2(&C[ci], c0, gvl);
	vse64.v	v8,0(a2)	# c0,* _285,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:308:             __riscv_vse64_v_f64m2(&C[ci], c1, gvl);
	vse64.v	v6,0(a3)	# c1,* _288,
	vsetivli	zero,8,e64,m2,ta,ma	#,,,,
.L24:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:312:         if (M & 2) {
	andi	a5,s4,2	#, _289, M
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:312:         if (M & 2) {
	beq	a5,zero,.L27	#, _289,,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:317:             BLASLONG ai = m_top * K;
	mul	a2,a6,t4	# ai, m_top, K
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:316:             double result3 = 0;
	fmv.d.x	fa5,zero	# result3,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:318:             BLASLONG bi = n_top * K;
	mul	a3,t4,s0	# bi, K, n_top
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:321:             for (BLASLONG k = 0; k < K; k++) {
	ble	t4,zero,.L53	#, K,,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:315:             double result2 = 0;
	fmv.d	fa4,fa5	# result2, result3
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:314:             double result1 = 0;
	fmv.d	fa3,fa5	# result1, result3
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:313:             double result0 = 0;
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:322:                 result0 += A[ai + 0] * B[bi + 0];
	vlseg2e64.v	v2,(a3)	# vect_array.277, vectp.276,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:322:                 result0 += A[ai + 0] * B[bi + 0];
	vlseg2e64.v	v4,(a2)	# vect_array.272, vectp.271,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:322:                 result0 += A[ai + 0] * B[bi + 0];
	vfmv.s.f	v12,fa2	# tmp991, result0
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:323:                 result1 += A[ai + 1] * B[bi + 0];
	vfmv.s.f	v11,fa3	# tmp993, result1
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:324:                 result2 += A[ai + 0] * B[bi + 1];
	vfmv.s.f	v10,fa4	# tmp995, result2
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:325:                 result3 += A[ai + 1] * B[bi + 1];
...
.L28:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:330:             BLASLONG ci = n_top * ldc + m_top;
	mul	a5,s6,s0	# _310, ldc, n_top
	vsetivli	zero,8,e64,m2,ta,ma	#,,,,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:330:             BLASLONG ci = n_top * ldc + m_top;
	add	a5,a5,a6	# m_top, ci, _310
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:331:             C[ci + 0 * ldc + 0] += alpha * result0;
	slli	a3,a5,3	#, _312, ci
	add	a1,t2,a3	# _312, _313, C
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:331:             C[ci + 0 * ldc + 0] += alpha * result0;
	fld	fa0,0(a1)	# *_313, *_313
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:332:             C[ci + 0 * ldc + 1] += alpha * result1;
	addi	a3,a3,8	#, _318, _312
	add	a3,t2,a3	# _318, _319, C
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:331:             C[ci + 0 * ldc + 0] += alpha * result0;
	fmadd.d	fa2,fa1,fa2,fa0	# _316, alpha, result0, *_313
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:333:             C[ci + 1 * ldc + 0] += alpha * result2;
	add	a5,s6,a5	# ci, _323, ldc
	slli	a5,a5,3	#, _325, _323
	add	a2,t2,a5	# _325, _326, C
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:334:             C[ci + 1 * ldc + 1] += alpha * result3;
	addi	a5,a5,8	#, _331, _325
	add	a5,t2,a5	# _331, _332, C
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:335:             m_top += 2;
...
.L27:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:338:         if (M & 1) {
	andi	a5,s4,1	#, _336, M
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:338:         if (M & 1) {
	beq	a5,zero,.L30	#, _336,,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:341:             BLASLONG ai = m_top * K;
	mul	a2,a6,t4	# ai, m_top, K
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:340:             double result1 = 0;
	fmv.d.x	fa5,zero	# result1,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:342:             BLASLONG bi = n_top * K;
	mul	a3,t4,s0	# bi, K, n_top
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:345:             for (BLASLONG k = 0; k < K; k++) {
	ble	t4,zero,.L54	#, K,,
	slli	a3,a3,3	#, _1844, bi
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:339:             double result0 = 0;
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:346:                 result0 += A[ai + 0] * B[bi + 0];
	vle64.v	v3,0(a2)	# vect__340.257,* vectp.256
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:346:                 result0 += A[ai + 0] * B[bi + 0];
	vle64.v	v2,0(a3)	# vect__344.260,* vectp.259
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:347:                 result1 += A[ai + 0] * B[bi + 1];
...
.L31:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:352:             BLASLONG ci = n_top * ldc + m_top;
	mul	a5,s6,s0	# _351, ldc, n_top
	vsetivli	zero,8,e64,m2,ta,ma	#,,,,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:352:             BLASLONG ci = n_top * ldc + m_top;
	add	a5,a5,a6	# m_top, ci, _351
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:353:             C[ci + 0 * ldc + 0] += alpha * result0;
	slli	a3,a5,3	#, _353, ci
	add	a3,t2,a3	# _353, _354, C
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:353:             C[ci + 0 * ldc + 0] += alpha * result0;
	fld	fa3,0(a3)	# *_354, *_354
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:354:             C[ci + 1 * ldc + 0] += alpha * result1;
...
.L30:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:363:     if (N & 1) {
	andi	a5,a7,1	#, _365, N
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:358:         n_top += 2;
	addi	s0,s0,2	#, n_top, n_top
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:363:     if (N & 1) {
	bne	a5,zero,.L317	#, _365,,
.L279:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:476: }
	ld	s0,168(sp)		#,
	.cfi_restore 8
	ld	s1,160(sp)		#,
	.cfi_restore 9
...
.L315:
	...
	.cfi_offset 26, -88
	.cfi_offset 27, -96
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:196:             BLASLONG ai = m_top * K;
	mul	a6,a4,t4	# ai, m_top, K
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:195:             double result3 = 0;
	fmv.d.x	fa5,zero	# result3,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:200:             for (BLASLONG k = 0; k < K; k++) {
	ble	t4,zero,.L51	#, K,,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:194:             double result2 = 0;
	fmv.d	fa4,fa5	# result2, result3
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:193:             double result1 = 0;
	fmv.d	fa3,fa5	# result1, result3
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:192:             double result0 = 0;
	fmv.d	fa2,fa5	# result0, result3
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:201:                 result0 += A[ai + 0] * B[bi + 0];
	vlseg4e64.v	v4,(a7)	# vect_array.295, vectp.294,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:201:                 result0 += A[ai + 0] * B[bi + 0];
	vle64.v	v1,0(a6)	# vect__182.292,* vectp.291
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:201:                 result0 += A[ai + 0] * B[bi + 0];
	vfmv.s.f	v12,fa2	# tmp999, result0
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:202:                 result1 += A[ai + 0] * B[bi + 1];
	vfmv.s.f	v11,fa3	# tmp1001, result1
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:203:                 result2 += A[ai + 0] * B[bi + 2];
	vfmv.s.f	v10,fa4	# tmp1003, result2
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:204:                 result3 += A[ai + 0] * B[bi + 3];
...
.L16:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:209:             BLASLONG ci = n_top * ldc + m_top;
	add	a4,s5,a4	# m_top, ci, ivtmp.478
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:210:             C[ci + 0 * ldc + 0] += alpha * result0;
	slli	a6,a4,3	#, _205, ci
	add	a6,t2,a6	# _205, _206, C
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:210:             C[ci + 0 * ldc + 0] += alpha * result0;
	fld	fa0,0(a6)	# *_206, *_206
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:211:             C[ci + 1 * ldc + 0] += alpha * result1;
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:212:             C[ci + 2 * ldc + 0] += alpha * result2;
	ld	a2,48(sp)		# _150, %sfp
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:213:             C[ci + 3 * ldc + 0] += alpha * result3;
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:213:             C[ci + 3 * ldc + 0] += alpha * result3;
	...
	j	.L15		#
.L313:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:94:             BLASLONG ai = m_top * K;
	mul	a0,t4,a4	# ai, K, m_top
	vsetivli	zero,4,e64,m2,ta,ma	#,,,,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:105:             vfloat64m2_t result0 = __riscv_vfmul_vf_f64m2(A0, B0, gvl);
	fld	fa2,-32(a1)	# MEM[(FLOAT *)_1632 + -32B], MEM[(FLOAT *)_1632 + -32B]
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:97:             double B1 = B[bi + 1];
	fld	fa3,-24(a1)	# B1, MEM[(FLOAT *)_1632 + -24B]
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:98:             double B2 = B[bi + 2];
	fld	fa4,-16(a1)	# B2, MEM[(FLOAT *)_1632 + -16B]
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:99:             double B3 = B[bi + 3];
	fld	fa5,-8(a1)	# B3, MEM[(FLOAT *)_1632 + -8B]
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:102:             vfloat64m2_t A0 = __riscv_vle64_v_f64m2(&A[ai + 0 * gvl], gvl);
	slli	a2,a0,3	#, _61, ai
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:102:             vfloat64m2_t A0 = __riscv_vle64_v_f64m2(&A[ai + 0 * gvl], gvl);
	add	a2,s3,a2	# _61, _62, A
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:102:             vfloat64m2_t A0 = __riscv_vle64_v_f64m2(&A[ai + 0 * gvl], gvl);
	vle64.v	v2,0(a2)	# A0,* _62
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:103:             ai += 4;
	addi	a0,a0,4	#, ai, ai
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:105:             vfloat64m2_t result0 = __riscv_vfmul_vf_f64m2(A0, B0, gvl);
	vfmul.vf	v6,v2,fa2	# result0, A0, MEM[(FLOAT *)_1632 + -32B],
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:106:             vfloat64m2_t result1 = __riscv_vfmul_vf_f64m2(A0, B1, gvl);
	vfmul.vf	v8,v2,fa3	# result1, A0, B1,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:107:             vfloat64m2_t result2 = __riscv_vfmul_vf_f64m2(A0, B2, gvl);
	vfmul.vf	v10,v2,fa4	# result2, A0, B2,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:108:             vfloat64m2_t result3 = __riscv_vfmul_vf_f64m2(A0, B3, gvl);
	vfmul.vf	v2,v2,fa5	# result3, A0, B3,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:111:             for (BLASLONG k = 1; k < K; k++) {
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:118:                 A0 = __riscv_vle64_v_f64m2(&A[ai + 0 * gvl], gvl);
	vle64.v	v4,0(a0)	# A0,* ivtmp.441
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:121:                 result0 = __riscv_vfmacc_vf_f64m2(result0, B0, A0, gvl);
	fld	fa2,0(a1)	# MEM[(FLOAT *)_431], MEM[(FLOAT *)_431]
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:113:                 B1 = B[bi + 1];
	fld	fa3,8(a1)	# B1, MEM[(FLOAT *)_431 + 8B]
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:114:                 B2 = B[bi + 2];
	fld	fa4,16(a1)	# B2, MEM[(FLOAT *)_431 + 16B]
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:115:                 B3 = B[bi + 3];
	fld	fa5,24(a1)	# B3, MEM[(FLOAT *)_431 + 24B]
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:111:             for (BLASLONG k = 1; k < K; k++) {
	addi	a0,a0,32	#, ivtmp.441, ivtmp.441
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:121:                 result0 = __riscv_vfmacc_vf_f64m2(result0, B0, A0, gvl);
	vfmacc.vf	v6,fa2,v4	# result0, MEM[(FLOAT *)_431], A0,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:122:                 result1 = __riscv_vfmacc_vf_f64m2(result1, B1, A0, gvl);
	vfmacc.vf	v8,fa3,v4	# result1, B1, A0,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:123:                 result2 = __riscv_vfmacc_vf_f64m2(result2, B2, A0, gvl);
	vfmacc.vf	v10,fa4,v4	# result2, B2, A0,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:124:                 result3 = __riscv_vfmacc_vf_f64m2(result3, B3, A0, gvl);
	vfmacc.vf	v2,fa5,v4	# result3, B3, A0,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:111:             for (BLASLONG k = 1; k < K; k++) {
...
.L10:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:127:             BLASLONG ci = n_top * ldc + m_top;
	add	a2,s5,a4	# m_top, ci, ivtmp.478
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:129:             vfloat64m2_t c0 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	slli	a7,a2,3	#, _80, ci
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:129:             vfloat64m2_t c0 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	add	a7,t2,a7	# _80, _81, C
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:129:             vfloat64m2_t c0 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	vle64.v	v14,0(a7)	# c0,* _81
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:130:             ci += ldc - gvl * 0;
	add	a2,s6,a2	# ci, ci, ldc
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:131:             vfloat64m2_t c1 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	slli	a6,a2,3	#, _83, ci
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:131:             vfloat64m2_t c1 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	add	a6,t2,a6	# _83, _84, C
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:131:             vfloat64m2_t c1 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	vle64.v	v12,0(a6)	# c1,* _84
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:132:             ci += ldc - gvl * 0;
	add	a2,s6,a2	# ci, ci, ldc
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:136:             c0 = __riscv_vfmacc_vf_f64m2(c0, alpha, result0, gvl);
	vfmacc.vf	v14,fa1,v6	# c0, alpha, result0,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:134:             ci += ldc - gvl * 0;
	add	a0,s6,a2	# ci, ci_739, ldc
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:135:             vfloat64m2_t c3 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	slli	a0,a0,3	#, _89, ci_739
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:133:             vfloat64m2_t c2 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	slli	a2,a2,3	#, _86, ci
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:133:             vfloat64m2_t c2 = __riscv_vle64_v_f64m2(&C[ci], gvl);
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:137:             c1 = __riscv_vfmacc_vf_f64m2(c1, alpha, result1, gvl);
	vfmacc.vf	v12,fa1,v8	# c1, alpha, result1,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:143:             __riscv_vse64_v_f64m2(&C[ci], c0, gvl);
	vse64.v	v14,0(a7)	# c0,* _81,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:150:             m_top += 4;
	addi	a4,a4,4	#, m_top, m_top
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:138:             c2 = __riscv_vfmacc_vf_f64m2(c2, alpha, result2, gvl);
	vfmacc.vf	v6,fa1,v10	# c2, alpha, result2,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:139:             c3 = __riscv_vfmacc_vf_f64m2(c3, alpha, result3, gvl);
	vfmacc.vf	v4,fa1,v2	# c3, alpha, result3,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:145:             __riscv_vse64_v_f64m2(&C[ci], c1, gvl);
	vse64.v	v12,0(a6)	# c1,* _84,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:147:             __riscv_vse64_v_f64m2(&C[ci], c2, gvl);
	vse64.v	v6,0(a2)	# c2,* _87,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:149:             __riscv_vse64_v_f64m2(&C[ci], c3, gvl);
	vse64.v	v4,0(a0)	# c3,* _90,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:153:         if (M & 2) {
	ld	a2,16(sp)		# _91, %sfp
	beq	a2,zero,.L12	#, _91,,
.L314:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:162:             BLASLONG ai = m_top * K;
	mul	a6,a4,t4	# ai, m_top, K
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:161:             double result7 = 0;
	fmv.d.x	fa5,zero	# result7,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:166:             for (BLASLONG k = 0; k < K; k++) {
	ble	t4,zero,.L50	#, K,,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:160:             double result6 = 0;
	fmv.d	fa4,fa5	# result6, result7
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:159:             double result5 = 0;
	fmv.d	fa3,fa5	# result5, result7
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:158:             double result4 = 0;
	fmv.d	fa2,fa5	# result4, result7
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:157:             double result3 = 0;
	fmv.d	fa0,fa5	# result3, result7
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:156:             double result2 = 0;
	fmv.d	ft0,fa5	# result2, result7
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:155:             double result1 = 0;
	fmv.d	ft1,fa5	# result1, result7
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:154:             double result0 = 0;
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:167:                 result0 += A[ai + 0] * B[bi + 0];
	vlseg2e64.v	v2,(a6)	# vect_array.312, vectp.311,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:167:                 result0 += A[ai + 0] * B[bi + 0];
	vlseg4e64.v	v4,(a7)	# vect_array.317, vectp.316,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:167:                 result0 += A[ai + 0] * B[bi + 0];
	vfmv.s.f	v22,ft2	# tmp1007, result0
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:168:                 result1 += A[ai + 1] * B[bi + 0];
	vfmv.s.f	v21,ft1	# tmp1009, result1
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:169:                 result2 += A[ai + 0] * B[bi + 1];
	vfmv.s.f	v20,ft0	# tmp1011, result2
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:170:                 result3 += A[ai + 1] * B[bi + 1];
	vfmv.s.f	v19,fa0	# tmp1013, result3
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:171:                 result4 += A[ai + 0] * B[bi + 2];
	vfmv.s.f	v18,fa2	# tmp1015, result4
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:172:                 result5 += A[ai + 1] * B[bi + 2];
	vfmv.s.f	v17,fa3	# tmp1017, result5
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:173:                 result6 += A[ai + 0] * B[bi + 3];
	vfmv.s.f	v16,fa4	# tmp1019, result6
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:174:                 result7 += A[ai + 1] * B[bi + 3];
...
.L13:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:179:             BLASLONG ci = n_top * ldc + m_top;
	add	a2,s5,a4	# m_top, ci, ivtmp.478
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:180:             C[ci + 0 * ldc + 0] += alpha * result0;
	slli	a6,a2,3	#, _126, ci
	add	a0,t2,a6	# _126, _127, C
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:180:             C[ci + 0 * ldc + 0] += alpha * result0;
	fld	ft3,0(a0)	# *_127, *_127
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:181:             C[ci + 0 * ldc + 1] += alpha * result1;
	addi	a6,a6,8	#, _132, _126
	add	a7,t2,a6	# _132, _133, C
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:180:             C[ci + 0 * ldc + 0] += alpha * result0;
	fmadd.d	ft2,fa1,ft2,ft3	# _130, alpha, result0, *_127
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:182:             C[ci + 1 * ldc + 0] += alpha * result2;
	add	a6,s6,a2	# ci, _137, ldc
	slli	a6,a6,3	#, _139, _137
	add	s10,t2,a6	# _139, _140, C
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:183:             C[ci + 1 * ldc + 1] += alpha * result3;
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:188:             m_top += 2;
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:185:             C[ci + 2 * ldc + 1] += alpha * result5;
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:187:             C[ci + 3 * ldc + 1] += alpha * result7;
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:187:             C[ci + 3 * ldc + 1] += alpha * result7;
	...
	j	.L12		#
.L49:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:26:         m_top = 0;
	li	a4,0		# m_top,
	j	.L5		#
.L311:
	.cfi_restore 25
...
.L317:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:367:         for (BLASLONG i = 0; i < M / 8; i += 1) {
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:369:             BLASLONG bi = n_top * K;
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:367:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	li	t5,0		# i,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:379:             for (BLASLONG k = 1; k < K; k++) {
	li	s1,1		# tmp859,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:389:             BLASLONG ci = n_top * ldc + m_top;
	mul	a6,s6,s0	# _521, ldc, n_top
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:370:             double B0 = B[bi + 0];
	slli	t3,t3,3	#, _368, bi_695
	add	t3,a4,t3	# _368, _369, B
	slli	a6,a6,3	#, _108, _521
	add	a6,t2,a6	# _108, ivtmp.377, C
.L38:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:373:             vfloat64m2_t A0 = __riscv_vle64_v_f64m2(&A[ai + 0 * gvl], gvl);
	vle64.v	v2,0(t1)	# A0,* ivtmp.376
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:376:             vfloat64m2_t result0 = __riscv_vfmul_vf_f64m2(A0, B0, gvl);
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:383:                 A0 = __riscv_vle64_v_f64m2(&A[ai + 0 * gvl], gvl);
	vle64.v	v4,0(a5)	# A0,* ivtmp.369
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:386:                 result0 = __riscv_vfmacc_vf_f64m2(result0, B0, A0, gvl);
...
.L36:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:391:             vfloat64m2_t c0 = __riscv_vle64_v_f64m2(&C[ci], gvl);
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:392:             c0 = __riscv_vfmacc_vf_f64m2(c0, alpha, result0, gvl);
	vfmacc.vf	v4,fa1,v2	# c0, alpha, result0,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:396:             __riscv_vse64_v_f64m2(&C[ci], c0, gvl);
...
.L35:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:400:         if (M & 4) {
	andi	a5,s4,4	#, _384, M
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:400:         if (M & 4) {
	beq	a5,zero,.L39	#, _384,,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:403:             BLASLONG ai = m_top * K;
	mul	a5,t4,a2	# ai, K, m_top
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:401:             gvl = __riscv_vsetvl_e64m2(4);
	vsetivli	zero,4,e64,m2,ta,ma	#,,,,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:414:             for (BLASLONG k = 1; k < K; k++) {
	li	a7,1		# tmp866,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:404:             BLASLONG bi = n_top * K;
	mul	a1,s0,t4	# bi.185_386, n_top, K
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:408:             vfloat64m2_t A0 = __riscv_vle64_v_f64m2(&A[ai + 0 * gvl], gvl);
	slli	a0,a5,3	#, _390, ai
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:408:             vfloat64m2_t A0 = __riscv_vle64_v_f64m2(&A[ai + 0 * gvl], gvl);
	add	a0,s3,a0	# _390, _391, A
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:408:             vfloat64m2_t A0 = __riscv_vle64_v_f64m2(&A[ai + 0 * gvl], gvl);
	vle64.v	v2,0(a0)	# A0,* _391
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:409:             ai += 4;
	addi	a5,a5,4	#, ai, ai
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:405:             double B0 = B[bi + 0];
	slli	a6,a1,3	#, _387, bi.185_386
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:405:             double B0 = B[bi + 0];
	add	a6,a4,a6	# _387, tmp864, B
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:411:             vfloat64m2_t result0 = __riscv_vfmul_vf_f64m2(A0, B0, gvl);
...
.L255:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:418:                 A0 = __riscv_vle64_v_f64m2(&A[ai + 0 * gvl], gvl);
	vle64.v	v4,0(a5)	# A0,* ivtmp.355
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:421:                 result0 = __riscv_vfmacc_vf_f64m2(result0, B0, A0, gvl);
...
.L40:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:424:             BLASLONG ci = n_top * ldc + m_top;
	mul	a5,s0,s6	# _398, n_top, ldc
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:424:             BLASLONG ci = n_top * ldc + m_top;
	add	a5,a5,a2	# m_top, ci_662, _398
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:426:             vfloat64m2_t c0 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	slli	a5,a5,3	#, _400, ci_662
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:426:             vfloat64m2_t c0 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	add	a5,t2,a5	# _400, _401, C
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:426:             vfloat64m2_t c0 = __riscv_vle64_v_f64m2(&C[ci], gvl);
	vle64.v	v4,0(a5)	# c0,* _401
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:432:             m_top += 4;
	addi	a2,a2,4	#, m_top, m_top
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:427:             c0 = __riscv_vfmacc_vf_f64m2(c0, alpha, result0, gvl);
	vfmacc.vf	v4,fa1,v2	# c0, alpha, result0,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:431:             __riscv_vse64_v_f64m2(&C[ci], c0, gvl);
	vse64.v	v4,0(a5)	# c0,* _401,
.L39:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:435:         if (M & 2) {
	andi	a5,s4,2	#, _402, M
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:435:         if (M & 2) {
	beq	a5,zero,.L42	#, _402,,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:438:             BLASLONG ai = m_top * K;
	mul	a1,a2,t4	# ai, m_top, K
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:437:             double result1 = 0;
	fmv.d.x	fa5,zero	# result1,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:439:             BLASLONG bi = n_top * K;
	mul	a3,s0,t4	# bi, n_top, K
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:442:             for (BLASLONG k = 0; k < K; k++) {
	ble	t4,zero,.L56	#, K,,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:436:             double result0 = 0;
	fmv.d	fa4,fa5	# result0, result1
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:443:                 result0 += A[ai + 0] * B[bi + 0];
	vlseg2e64.v	v4,(a1)	# vect_array.243, vectp.242,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:443:                 result0 += A[ai + 0] * B[bi + 0];
	vle64.v	v1,0(a3)	# vect__410.248,* vectp.247
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:443:                 result0 += A[ai + 0] * B[bi + 0];
	vfmv.s.f	v6,fa4	# tmp983, result0
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:444:                 result1 += A[ai + 1] * B[bi + 0];
...
.L43:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:449:             BLASLONG ci = n_top * ldc + m_top;
	mul	a5,s0,s6	# _417, n_top, ldc
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:449:             BLASLONG ci = n_top * ldc + m_top;
	add	a5,a5,a2	# m_top, ci_677, _417
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:450:             C[ci + 0 * ldc + 0] += alpha * result0;
	slli	a5,a5,3	#, _419, ci_677
	add	a3,t2,a5	# _419, _420, C
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:450:             C[ci + 0 * ldc + 0] += alpha * result0;
	fld	fa3,0(a3)	# *_420, *_420
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:451:             C[ci + 0 * ldc + 1] += alpha * result1;
	addi	a5,a5,8	#, _425, _419
	add	a5,t2,a5	# _425, _426, C
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:450:             C[ci + 0 * ldc + 0] += alpha * result0;
	fmadd.d	fa4,fa1,fa4,fa3	# _423, alpha, result0, *_420
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:452:             m_top += 2;
...
.L42:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:455:         if (M & 1) {
	andi	s4,s4,1	#, _430, M
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:455:         if (M & 1) {
	beq	s4,zero,.L279	#, _430,,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:457:             BLASLONG ai = m_top * K;
	mul	a3,a2,t4	# ai, m_top, K
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:456:             double result0 = 0;
	fmv.d.x	fa5,zero	# result0,
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:458:             BLASLONG bi = n_top * K;
	mul	a5,s0,t4	# bi, n_top, K
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:461:             for (BLASLONG k = 0; k < K; k++) {
	ble	t4,zero,.L46	#, K,,
...
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:462:                 result0 += A[ai + 0] * B[bi + 0];
...
.L46:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:467:             BLASLONG ci = n_top * ldc + m_top;
	mul	a5,s0,s6	# _440, n_top, ldc
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:467:             BLASLONG ci = n_top * ldc + m_top;
	add	a5,a5,a2	# m_top, ci_688, _440
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:468:             C[ci + 0 * ldc + 0] += alpha * result0;
...
.L52:
	...
	.cfi_restore 26
	.cfi_restore 27
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:224:         m_top = 0;
	li	a6,0		# m_top,
	j	.L20		#
.L55:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:365:         m_top = 0;
	li	a2,0		# m_top,
	j	.L35		#
.L48:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:21:     BLASLONG n_top = 0;
	li	s0,0		# n_top,
	j	.L2		#
.L318:
# dgemm_kernel_8x4_zvl128b_lmul2_unroll8.c:418:                 A0 = __riscv_vle64_v_f64m2(&A[ai + 0 * gvl], gvl);
