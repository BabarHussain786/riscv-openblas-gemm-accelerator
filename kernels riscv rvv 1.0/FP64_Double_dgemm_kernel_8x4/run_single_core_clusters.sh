...
echo "=========================================================="
echo " Running FP64 Benchmarks (Single-Core Mode)"
...
for dir in "${DIRS[@]}"; do
    if [ -d "$dir" ]; then
        ...
        if [ -f "./bench" ]; then
            ...
            # Let the CPU cool down before hitting the next core
            echo "    Cooling down for 5 seconds..."
            sleep 5

            # -------------------------------
            # Core 4 -> General Cluster (Cluster 1)
            # -------------------------------
        ...
        # Let the CPU cool down heavily before the next kernel compilation
        echo ">>> Cooling down for 10 seconds before next kernel..."
        sleep 10
    else
...
echo "----------------------------------------------------------"
echo "ALL SINGLE-CORE BENCHMARKS COMPLETE!"
echo "=========================================================="
echo "Results saved to:"
echo "  - core0_ai_results/"
echo "  - core4_general_results/"
echo "=========================================================="
