...
LOGFILE="benchmark_dgemm_8x4_lmul4_unroll4_$(date +%Y%m%d_%H%M%S).log"

echo "===============================================" | tee "$LOGFILE"
echo "RVV DGEMM BENCHMARK (FP64 8x4 - LMUL 4 Unroll 4)" | tee -a "$LOGFILE"
...
# Testing with 2048x2048x2048 matrices
