...
LOGFILE="benchmark_dgemm_8x4_lmul4_unroll8_$(date +%Y%m%d_%H%M%S).log"

echo "===============================================" | tee "$LOGFILE"
echo "RVV DGEMM BENCHMARK (FP64 8x4 - LMUL 4 Unroll 8)" | tee -a "$LOGFILE"
...
# Running with 2048x2048x2048 matrices as the baseline for FP64
