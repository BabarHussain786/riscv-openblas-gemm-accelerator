	.file	"igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c"
	.option nopic
...
.LFB0:
	.cfi_startproc
	mv	t5,a1	# N, tmp1189
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:26:     for (BLASLONG j = 0; j < N / 4; j += 1) {
	srai	a1,a1,63	#, tmp811, N
	andi	a1,a1,3	#, tmp812, tmp811
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:19: {
	addi	sp,sp,-224	#,,
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:30:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	mv	a4,a0	# M, M
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:93:         if (M & 4) {
	andi	s0,a4,4	#, _32, M
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:30:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	srai	a6,a0,63	#, tmp818, M
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:187:             C[ci + 2 * ldc + 0] += alpha * result4;
	slli	a1,a7,1	#, _275, ldc
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:93:         if (M & 4) {
	sd	s0,40(sp)	# _32, %sfp
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:156:         if (M & 2) {
	andi	s0,a4,2	#, _63, M
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:194:         if (M & 1) {
	andi	a4,a4,1	#, _183, M
	slli	a5,a2,2	#, _2056, K
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:30:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	andi	a6,a6,7	#, tmp819, tmp818
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:189:             C[ci + 3 * ldc + 0] += alpha * result6;
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:169:             for (BLASLONG k = 0; k < K; k++) {
	sd	s9,120(sp)	# B, %sfp
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:194:         if (M & 1) {
	li	t6,0		# ivtmp.660,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:26:     for (BLASLONG j = 0; j < N / 4; j += 1) {
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:48:             for (BLASLONG k = 1; k < K; k++) {
	li	a7,1		# tmp1108,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:336:             C[ci + 0 * ldc + 0] += alpha * result0;
...
.L8:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:39:             vint8m1_t A0 = __riscv_vle8_v_i8m1(&A[ai + 0 * gvl], gvl);
	vle8.v	v1,0(s4)	# A0,* ivtmp.647
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:42:             vint8m1_t result0 = __riscv_vmul_vx_i8m1(A0, B0, gvl);
	lbu	s7,-4(a4)	# MEM[(FLOAT *)_187 + -4B], MEM[(FLOAT *)_187 + -4B]
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:43:             vint8m1_t result1 = __riscv_vmul_vx_i8m1(A0, B1, gvl);
	lbu	s2,-3(a4)	# MEM[(FLOAT *)_187 + -3B], MEM[(FLOAT *)_187 + -3B]
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:44:             vint8m1_t result2 = __riscv_vmul_vx_i8m1(A0, B2, gvl);
	lbu	t6,-2(a4)	# MEM[(FLOAT *)_187 + -2B], MEM[(FLOAT *)_187 + -2B]
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:45:             vint8m1_t result3 = __riscv_vmul_vx_i8m1(A0, B3, gvl);
	lbu	t5,-1(a4)	# MEM[(FLOAT *)_187 + -1B], MEM[(FLOAT *)_187 + -1B]
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:42:             vint8m1_t result0 = __riscv_vmul_vx_i8m1(A0, B0, gvl);
	vmul.vx	v3,v1,s7	# result0, A0, MEM[(FLOAT *)_187 + -4B],
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:43:             vint8m1_t result1 = __riscv_vmul_vx_i8m1(A0, B1, gvl);
	vmul.vx	v4,v1,s2	# result1, A0, MEM[(FLOAT *)_187 + -3B],
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:44:             vint8m1_t result2 = __riscv_vmul_vx_i8m1(A0, B2, gvl);
	vmul.vx	v5,v1,t6	# result2, A0, MEM[(FLOAT *)_187 + -2B],
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:45:             vint8m1_t result3 = __riscv_vmul_vx_i8m1(A0, B3, gvl);
	vmul.vx	v1,v1,t5	# result3, A0, MEM[(FLOAT *)_187 + -1B],
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:48:             for (BLASLONG k = 1; k < K; k++) {
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:55:                 A0 = __riscv_vle8_v_i8m1(&A[ai + 0 * gvl], gvl);
	vle8.v	v2,0(t6)	# A0,* ivtmp.640
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:58:                 result0 = __riscv_vmacc_vx_i8m1(result0, B0, A0, gvl);
	lbu	s11,0(a4)	# MEM[(FLOAT *)_697], MEM[(FLOAT *)_697]
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:59:                 result1 = __riscv_vmacc_vx_i8m1(result1, B1, A0, gvl);
	lbu	s8,1(a4)	# MEM[(FLOAT *)_697 + 1B], MEM[(FLOAT *)_697 + 1B]
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:60:                 result2 = __riscv_vmacc_vx_i8m1(result2, B2, A0, gvl);
	lbu	s7,2(a4)	# MEM[(FLOAT *)_697 + 2B], MEM[(FLOAT *)_697 + 2B]
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:61:                 result3 = __riscv_vmacc_vx_i8m1(result3, B3, A0, gvl);
	lbu	s2,3(a4)	# MEM[(FLOAT *)_697 + 3B], MEM[(FLOAT *)_697 + 3B]
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:48:             for (BLASLONG k = 1; k < K; k++) {
	addi	t5,a4,4	#, ivtmp.638, ivtmp.664
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:58:                 result0 = __riscv_vmacc_vx_i8m1(result0, B0, A0, gvl);
	vmacc.vx	v3,s11,v2	# result0, MEM[(FLOAT *)_697], A0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:59:                 result1 = __riscv_vmacc_vx_i8m1(result1, B1, A0, gvl);
	vmacc.vx	v4,s8,v2	# result1, MEM[(FLOAT *)_697 + 1B], A0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:60:                 result2 = __riscv_vmacc_vx_i8m1(result2, B2, A0, gvl);
	vmacc.vx	v5,s7,v2	# result2, MEM[(FLOAT *)_697 + 2B], A0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:61:                 result3 = __riscv_vmacc_vx_i8m1(result3, B3, A0, gvl);
	vmacc.vx	v1,s2,v2	# result3, MEM[(FLOAT *)_697 + 3B], A0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:48:             for (BLASLONG k = 1; k < K; k++) {
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:58:                 result0 = __riscv_vmacc_vx_i8m1(result0, B0, A0, gvl);
	vmacc.vx	v3,s8,v2	# result0, MEM[(FLOAT *)_697], A0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:59:                 result1 = __riscv_vmacc_vx_i8m1(result1, B1, A0, gvl);
	vmacc.vx	v4,s7,v2	# result1, MEM[(FLOAT *)_697 + 1B], A0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:60:                 result2 = __riscv_vmacc_vx_i8m1(result2, B2, A0, gvl);
	vmacc.vx	v5,s4,v2	# result2, MEM[(FLOAT *)_697 + 2B], A0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:61:                 result3 = __riscv_vmacc_vx_i8m1(result3, B3, A0, gvl);
	vmacc.vx	v1,s2,v2	# result3, MEM[(FLOAT *)_697 + 3B], A0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:55:                 A0 = __riscv_vle8_v_i8m1(&A[ai + 0 * gvl], gvl);
	vle8.v	v2,0(s11)	# A0,
...
.L6:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:66:             vint8m1_t c0 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	vle8.v	v8,0(s3)	# c0,* ivtmp.648
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:68:             vint8m1_t c1 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	vle8.v	v7,0(s1)	# c1,* ivtmp.649
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:70:             vint8m1_t c2 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	add	t6,a1,s3	# ivtmp.648, _28, _275
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:72:             vint8m1_t c3 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	add	t5,a1,s1	# ivtmp.649, _30, _275
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:70:             vint8m1_t c2 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	vle8.v	v6,0(t6)	# c2,* _28
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:72:             vint8m1_t c3 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	vle8.v	v2,0(t5)	# c3,* _30
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:74:             c0 = __riscv_vmacc_vx_i8m1(c0, alpha, result0, gvl);
	vmacc.vx	v8,a3,v3	# c0, alpha, result0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:75:             c1 = __riscv_vmacc_vx_i8m1(c1, alpha, result1, gvl);
	vmacc.vx	v7,a3,v4	# c1, alpha, result1,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:30:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	addi	s5,s5,1	#, i, i
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:30:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	add	s4,s4,t3	# _942, ivtmp.647, ivtmp.647
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:81:             __riscv_vse8_v_i8m1(&C[ci], c0, gvl);
	vse8.v	v8,0(s3)	# c0,* ivtmp.648,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:76:             c2 = __riscv_vmacc_vx_i8m1(c2, alpha, result2, gvl);
	vmacc.vx	v6,a3,v5	# c2, alpha, result2,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:77:             c3 = __riscv_vmacc_vx_i8m1(c3, alpha, result3, gvl);
	vmacc.vx	v2,a3,v1	# c3, alpha, result3,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:30:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	addi	s3,s3,8	#, ivtmp.648, ivtmp.648
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:83:             __riscv_vse8_v_i8m1(&C[ci], c1, gvl);
	vse8.v	v7,0(s1)	# c1,* ivtmp.649,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:30:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	addi	s1,s1,8	#, ivtmp.649, ivtmp.649
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:85:             __riscv_vse8_v_i8m1(&C[ci], c2, gvl);
	vse8.v	v6,0(t6)	# c2,* _28,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:87:             __riscv_vse8_v_i8m1(&C[ci], c3, gvl);
...
.L2:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:225:     if (N & 2) {
	andi	a5,t5,2	#, _256, N
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:225:     if (N & 2) {
	beq	a5,zero,.L19	#, _256,,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:229:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	ld	a2,24(sp)		# M, %sfp
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:229:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	li	a4,7		# tmp969,
	vsetivli	zero,8,e8,m1,ta,ma	#,,,,
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:231:             BLASLONG bi = n_top * K;
	mul	s0,t1,a0	# bi, K, n_top
	slli	t0,t1,1	#, _1021, K
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:243:             for (BLASLONG k = 1; k < K; k++) {
	li	s3,1		# tmp978,
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:229:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	li	t2,0		# i,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:255:             BLASLONG ci = n_top * ldc + m_top;
	mul	a7,s11,a0	# _270, ldc, n_top
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:233:             int8_t B1 = B[bi + 1];
	add	s1,s0,s3	#, _260, bi
	add	t0,t0,s0	# bi, _1023, _2300
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:232:             int8_t B0 = B[bi + 0];
	add	s2,s9,s0	# bi, _259, B
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:233:             int8_t B1 = B[bi + 1];
	add	s1,s9,s1	# _260, _261, B
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:234:             bi += 2;
	addi	s0,s0,2	#, bi, bi
	add	a7,t4,a7	# _270, ivtmp.610, C
.L23:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:236:             vint8m1_t A0 = __riscv_vle8_v_i8m1(&A[ai + 0 * gvl], gvl);
	vle8.v	v1,0(t6)	# A0,* ivtmp.609
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:239:             vint8m1_t result0 = __riscv_vmul_vx_i8m1(A0, B0, gvl);
	lbu	a2,0(s2)	# *_259, *_259
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:240:             vint8m1_t result1 = __riscv_vmul_vx_i8m1(A0, B1, gvl);
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:248:                 A0 = __riscv_vle8_v_i8m1(&A[ai + 0 * gvl], gvl);
	vle8.v	v3,0(a2)	# A0,* ivtmp.600
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:251:                 result0 = __riscv_vmacc_vx_i8m1(result0, B0, A0, gvl);
	lbu	a6,0(a4)	# MEM[(FLOAT *)_297], MEM[(FLOAT *)_297]
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:252:                 result1 = __riscv_vmacc_vx_i8m1(result1, B1, A0, gvl);
	lbu	a1,1(a4)	# MEM[(FLOAT *)_297 + 1B], MEM[(FLOAT *)_297 + 1B]
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:243:             for (BLASLONG k = 1; k < K; k++) {
	addi	a2,t6,16	#, ivtmp.600, ivtmp.609
	addi	a4,a4,2	#, ivtmp.598, ivtmp.598
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:251:                 result0 = __riscv_vmacc_vx_i8m1(result0, B0, A0, gvl);
	vmacc.vx	v2,a6,v3	# result0, MEM[(FLOAT *)_297], A0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:252:                 result1 = __riscv_vmacc_vx_i8m1(result1, B1, A0, gvl);
...
.L21:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:257:             vint8m1_t c0 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	vle8.v	v4,0(a7)	# c0,* ivtmp.610
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:259:             vint8m1_t c1 = __riscv_vle8_v_i8m1(&C[ci], gvl);
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:261:             c0 = __riscv_vmacc_vx_i8m1(c0, alpha, result0, gvl);
	vmacc.vx	v4,a3,v2	# c0, alpha, result0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:262:             c1 = __riscv_vmacc_vx_i8m1(c1, alpha, result1, gvl);
	vmacc.vx	v3,a3,v1	# c1, alpha, result1,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:266:             __riscv_vse8_v_i8m1(&C[ci], c0, gvl);
	vse8.v	v4,0(a7)	# c0,* ivtmp.610,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:229:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	addi	a7,a7,8	#, ivtmp.610, ivtmp.610
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:268:             __riscv_vse8_v_i8m1(&C[ci], c1, gvl);
	vse8.v	v3,0(a4)	# c1,* _274,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:229:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	blt	t2,t3,.L23	#, i, _854,
	slli	t3,t3,3	#, m_top, _854
.L20:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:272:         if (M & 4) {
	ld	a5,24(sp)		# M, %sfp
	andi	a5,a5,4	#, _276, M
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:272:         if (M & 4) {
	beq	a5,zero,.L24	#, _276,,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:275:             BLASLONG ai = m_top * K;
	mul	a4,t1,t3	# ai, K, m_top
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:273:             gvl = __riscv_vsetvl_e8m1(4);
	vsetivli	zero,4,e8,m1,ta,ma	#,,,,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:288:             for (BLASLONG k = 1; k < K; k++) {
	li	a6,1		# tmp991,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:276:             BLASLONG bi = n_top * K;
	mul	a1,t1,a0	# bi, K, n_top
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:281:             vint8m1_t A0 = __riscv_vle8_v_i8m1(&A[ai + 0 * gvl], gvl);
	add	a2,s10,a4	# ai, _283, A
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:281:             vint8m1_t A0 = __riscv_vle8_v_i8m1(&A[ai + 0 * gvl], gvl);
	vle8.v	v1,0(a2)	# A0,* _283
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:282:             ai += 4;
	addi	a4,a4,4	#, ai, ai
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:277:             int8_t B0 = B[bi + 0];
	add	a2,s9,a1	# bi, tmp985, B
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:284:             vint8m1_t result0 = __riscv_vmul_vx_i8m1(A0, B0, gvl);
	lbu	a7,0(a2)	# *_279, *_279
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:285:             vint8m1_t result1 = __riscv_vmul_vx_i8m1(A0, B1, gvl);
	lbu	a2,1(a2)	# *_281, *_281
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:284:             vint8m1_t result0 = __riscv_vmul_vx_i8m1(A0, B0, gvl);
	vmul.vx	v2,v1,a7	# result0, A0, *_279,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:285:             vint8m1_t result1 = __riscv_vmul_vx_i8m1(A0, B1, gvl);
	vmul.vx	v1,v1,a2	# result1, A0, *_281,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:279:             bi += 2;
	addi	a2,a1,2	#, bi, bi
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:288:             for (BLASLONG k = 1; k < K; k++) {
...
.L243:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:293:                 A0 = __riscv_vle8_v_i8m1(&A[ai + 0 * gvl], gvl);
	vle8.v	v3,0(a4)	# A0,* ivtmp.584
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:296:                 result0 = __riscv_vmacc_vx_i8m1(result0, B0, A0, gvl);
	lbu	a6,0(a2)	# MEM[(FLOAT *)_315], MEM[(FLOAT *)_315]
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:297:                 result1 = __riscv_vmacc_vx_i8m1(result1, B1, A0, gvl);
	lbu	a1,1(a2)	# MEM[(FLOAT *)_315 + 1B], MEM[(FLOAT *)_315 + 1B]
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:288:             for (BLASLONG k = 1; k < K; k++) {
	addi	a4,a4,4	#, ivtmp.584, ivtmp.584
	addi	a2,a2,2	#, ivtmp.582, ivtmp.582
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:296:                 result0 = __riscv_vmacc_vx_i8m1(result0, B0, A0, gvl);
	vmacc.vx	v2,a6,v3	# result0, MEM[(FLOAT *)_315], A0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:297:                 result1 = __riscv_vmacc_vx_i8m1(result1, B1, A0, gvl);
...
.L25:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:300:             BLASLONG ci = n_top * ldc + m_top;
	mul	a4,s11,a0	# _290, ldc, n_top
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:300:             BLASLONG ci = n_top * ldc + m_top;
	add	a4,a4,t3	# m_top, ci, _290
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:302:             vint8m1_t c0 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	add	a2,t4,a4	# ci, _292, C
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:302:             vint8m1_t c0 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	vle8.v	v4,0(a2)	# c0,* _292
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:303:             ci += ldc - gvl * 0;
	add	a4,s11,a4	# ci, ci_603, ldc
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:304:             vint8m1_t c1 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	add	a4,t4,a4	# ci_603, _294, C
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:304:             vint8m1_t c1 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	vle8.v	v3,0(a4)	# c1,* _294
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:314:             m_top += 4;
	addi	t3,t3,4	#, m_top, m_top
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:306:             c0 = __riscv_vmacc_vx_i8m1(c0, alpha, result0, gvl);
	vmacc.vx	v4,a3,v2	# c0, alpha, result0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:307:             c1 = __riscv_vmacc_vx_i8m1(c1, alpha, result1, gvl);
	vmacc.vx	v3,a3,v1	# c1, alpha, result1,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:311:             __riscv_vse8_v_i8m1(&C[ci], c0, gvl);
	vse8.v	v4,0(a2)	# c0,* _292,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:313:             __riscv_vse8_v_i8m1(&C[ci], c1, gvl);
	vse8.v	v3,0(a4)	# c1,* _294,
.L24:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:317:         if (M & 2) {
	ld	a5,24(sp)		# M, %sfp
	andi	a5,a5,2	#, _295, M
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:317:         if (M & 2) {
	beq	a5,zero,.L27	#, _295,,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:322:             BLASLONG ai = m_top * K;
	mul	a1,t3,t1	# ai, m_top, K
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:336:             C[ci + 0 * ldc + 0] += alpha * result0;
	andi	a7,a3,0xff	# _2315, alpha
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:323:             BLASLONG bi = n_top * K;
	mul	a2,t1,a0	# bi, K, n_top
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:326:             for (BLASLONG k = 0; k < K; k++) {
	ble	t1,zero,.L53	#, K,,
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:327:                 result0 += A[ai + 0] * B[bi + 0];
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:328:                 result1 += A[ai + 1] * B[bi + 0];
	vmacc.vv	v7,v5,v2	# vect_result1_1017.367, vect_array.372, vect_array.378,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:329:                 result2 += A[ai + 0] * B[bi + 1];
	vmacc.vv	v8,v4,v3	# vect_result2_1019.368, vect_array.372, vect_array.378,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:330:                 result3 += A[ai + 1] * B[bi + 1];
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:339:             C[ci + 1 * ldc + 1] += alpha * result3;
	mulw	a4,a4,a7	# tmp1012, _2050, _2315
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:338:             C[ci + 1 * ldc + 0] += alpha * result2;
	mulw	a2,a2,a7	# tmp1010, _2060, _2315
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:339:             C[ci + 1 * ldc + 1] += alpha * result3;
	andi	a4,a4,0xff	# _2171, tmp1012
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:337:             C[ci + 0 * ldc + 1] += alpha * result1;
...
.L28:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:335:             BLASLONG ci = n_top * ldc + m_top;
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:340:             m_top += 2;
...
.L27:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:343:         if (M & 1) {
	ld	a5,24(sp)		# M, %sfp
	andi	a5,a5,1	#, _359, M
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:343:         if (M & 1) {
	beq	a5,zero,.L30	#, _359,,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:346:             BLASLONG ai = m_top * K;
	mul	a6,t3,t1	# ai, m_top, K
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:336:             C[ci + 0 * ldc + 0] += alpha * result0;
	andi	a7,a3,0xff	# _2314, alpha
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:347:             BLASLONG bi = n_top * K;
	mul	a2,t1,a0	# bi, K, n_top
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:350:             for (BLASLONG k = 0; k < K; k++) {
	ble	t1,zero,.L54	#, K,,
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:351:                 result0 += A[ai + 0] * B[bi + 0];
	vle8.v	v3,0(a6)	# vect__362.342,* vectp.341
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:351:                 result0 += A[ai + 0] * B[bi + 0];
	vle8.v	v5,0(a2)	# vect__366.346,* vectp.345
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:352:                 result1 += A[ai + 0] * B[bi + 1];
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:359:             C[ci + 1 * ldc + 0] += alpha * result1;
	mulw	a4,a4,a7	# tmp1039, _2118, _2314
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:358:             C[ci + 0 * ldc + 0] += alpha * result0;
...
.L31:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:357:             BLASLONG ci = n_top * ldc + m_top;
...
.L30:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:363:         n_top += 2;
	addi	a0,a0,2	#, n_top, n_top
.L19:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:368:     if (N & 1) {
	andi	a5,t5,1	#, _397, N
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:368:     if (N & 1) {
	beq	a5,zero,.L279	#, _397,,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:372:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	ld	a2,24(sp)		# M, %sfp
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:372:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	li	a4,7		# tmp1057,
	vsetivli	zero,8,e8,m1,ta,ma	#,,,,
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:374:             BLASLONG bi = n_top * K;
	mul	a4,a0,t1	# bi.226_399, n_top, K
	add	t3,s9,t1	# K, _2276, B
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:384:             for (BLASLONG k = 1; k < K; k++) {
	li	s1,1		# tmp1061,
	slli	s2,t1,3	#, _972, K
	mv	a7,s10	# ivtmp.567, A
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:372:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	li	t5,0		# i,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:394:             BLASLONG ci = n_top * ldc + m_top;
	mul	a6,a0,s11	# _407, n_top, ldc
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:375:             int8_t B0 = B[bi + 0];
	add	s0,s9,a4	# bi.226_399, _400, B
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:376:             bi += 1;
	add	t2,a4,s1	#, bi, bi.226_399
	add	t3,t3,a4	# bi.226_399, _66, _2276
	add	a6,t4,a6	# _407, ivtmp.568, C
.L38:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:378:             vint8m1_t A0 = __riscv_vle8_v_i8m1(&A[ai + 0 * gvl], gvl);
	vle8.v	v1,0(a7)	# A0,* ivtmp.567
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:381:             vint8m1_t result0 = __riscv_vmul_vx_i8m1(A0, B0, gvl);
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:388:                 A0 = __riscv_vle8_v_i8m1(&A[ai + 0 * gvl], gvl);
	vle8.v	v2,0(a4)	# A0,* ivtmp.560
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:391:                 result0 = __riscv_vmacc_vx_i8m1(result0, B0, A0, gvl);
...
.L36:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:396:             vint8m1_t c0 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	vle8.v	v2,0(a6)	# c0,* ivtmp.568
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:372:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	addi	t5,t5,1	#, i, i
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:372:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	add	a7,a7,s2	# _972, ivtmp.567, ivtmp.567
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:397:             c0 = __riscv_vmacc_vx_i8m1(c0, alpha, result0, gvl);
	vmacc.vx	v2,a3,v1	# c0, alpha, result0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:401:             __riscv_vse8_v_i8m1(&C[ci], c0, gvl);
	vse8.v	v2,0(a6)	# c0,* ivtmp.568,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:372:         for (BLASLONG i = 0; i < M / 8; i += 1) {
	addi	a6,a6,8	#, ivtmp.568, ivtmp.568
	blt	t5,t6,.L38	#, i, _877,
	slli	a1,t6,3	#, m_top, _877
.L35:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:405:         if (M & 4) {
	ld	a5,24(sp)		# M, %sfp
	andi	a5,a5,4	#, _411, M
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:405:         if (M & 4) {
	beq	a5,zero,.L39	#, _411,,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:408:             BLASLONG ai = m_top * K;
	mul	a5,t1,a1	# ai, K, m_top
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:406:             gvl = __riscv_vsetvl_e8m1(4);
	vsetivli	zero,4,e8,m1,ta,ma	#,,,,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:419:             for (BLASLONG k = 1; k < K; k++) {
	li	t3,1		# tmp1070,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:409:             BLASLONG bi = n_top * K;
	mul	a6,a0,t1	# bi, n_top, K
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:413:             vint8m1_t A0 = __riscv_vle8_v_i8m1(&A[ai + 0 * gvl], gvl);
	add	a4,s10,a5	# ai, _416, A
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:413:             vint8m1_t A0 = __riscv_vle8_v_i8m1(&A[ai + 0 * gvl], gvl);
	vle8.v	v1,0(a4)	# A0,* _416
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:414:             ai += 4;
	addi	a5,a5,4	#, ai, ai
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:410:             int8_t B0 = B[bi + 0];
	add	a4,s9,a6	# bi, tmp1067, B
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:416:             vint8m1_t result0 = __riscv_vmul_vx_i8m1(A0, B0, gvl);
	lbu	a7,0(a4)	# *_414, *_414
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:411:             bi += 1;
	add	a4,a6,t3	#, bi, bi
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:416:             vint8m1_t result0 = __riscv_vmul_vx_i8m1(A0, B0, gvl);
...
.L255:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:423:                 A0 = __riscv_vle8_v_i8m1(&A[ai + 0 * gvl], gvl);
	vle8.v	v2,0(a5)	# A0,* ivtmp.546
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:426:                 result0 = __riscv_vmacc_vx_i8m1(result0, B0, A0, gvl);
	lbu	a6,0(a4)	# MEM[(FLOAT *)_87], MEM[(FLOAT *)_87]
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:419:             for (BLASLONG k = 1; k < K; k++) {
	addi	a5,a5,4	#, ivtmp.546, ivtmp.546
	addi	a4,a4,1	#, ivtmp.544, ivtmp.544
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:426:                 result0 = __riscv_vmacc_vx_i8m1(result0, B0, A0, gvl);
	vmacc.vx	v1,a6,v2	# result0, MEM[(FLOAT *)_87], A0,
.L254:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:423:                 A0 = __riscv_vle8_v_i8m1(&A[ai + 0 * gvl], gvl);
	vle8.v	v2,0(a5)	# A0,* ivtmp.546
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:426:                 result0 = __riscv_vmacc_vx_i8m1(result0, B0, A0, gvl);
...
.L40:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:429:             BLASLONG ci = n_top * ldc + m_top;
	mul	a5,a0,s11	# _421, n_top, ldc
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:429:             BLASLONG ci = n_top * ldc + m_top;
	add	a5,a5,a1	# m_top, ci_679, _421
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:431:             vint8m1_t c0 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	add	a5,t4,a5	# ci_679, _423, C
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:431:             vint8m1_t c0 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	vle8.v	v2,0(a5)	# c0,* _423
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:437:             m_top += 4;
	addi	a1,a1,4	#, m_top, m_top
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:432:             c0 = __riscv_vmacc_vx_i8m1(c0, alpha, result0, gvl);
	vmacc.vx	v2,a3,v1	# c0, alpha, result0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:436:             __riscv_vse8_v_i8m1(&C[ci], c0, gvl);
	vse8.v	v2,0(a5)	# c0,* _423,
.L39:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:440:         if (M & 2) {
	ld	a5,24(sp)		# M, %sfp
	andi	a5,a5,2	#, _424, M
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:440:         if (M & 2) {
	beq	a5,zero,.L42	#, _424,,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:443:             BLASLONG ai = m_top * K;
	mul	a6,a1,t1	# ai, m_top, K
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:336:             C[ci + 0 * ldc + 0] += alpha * result0;
	andi	a7,a3,0xff	# _2313, alpha
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:444:             BLASLONG bi = n_top * K;
	mul	a2,a0,t1	# bi, n_top, K
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:447:             for (BLASLONG k = 0; k < K; k++) {
	ble	t1,zero,.L56	#, K,,
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:448:                 result0 += A[ai + 0] * B[bi + 0];
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:449:                 result1 += A[ai + 1] * B[bi + 0];
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:456:             C[ci + 0 * ldc + 1] += alpha * result1;
	mulw	a4,a4,a7	# tmp1083, _2183, _2313
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:455:             C[ci + 0 * ldc + 0] += alpha * result0;
...
.L43:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:454:             BLASLONG ci = n_top * ldc + m_top;
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:457:             m_top += 2;
...
.L42:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:460:         if (M & 1) {
	ld	a5,24(sp)		# M, %sfp
	andi	a5,a5,1	#, _461, M
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:460:         if (M & 1) {
	beq	a5,zero,.L279	#, _461,,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:462:             BLASLONG ai = m_top * K;
	mul	a2,a1,t1	# ai, m_top, K
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:336:             C[ci + 0 * ldc + 0] += alpha * result0;
	andi	a3,a3,0xff	# _2312, alpha
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:463:             BLASLONG bi = n_top * K;
	mul	a4,a0,t1	# bi, n_top, K
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:466:             for (BLASLONG k = 0; k < K; k++) {
	ble	t1,zero,.L57	#, K,,
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:467:                 result0 += A[ai + 0] * B[bi + 0];
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:473:             C[ci + 0 * ldc + 0] += alpha * result0;
	mulw	a5,a5,a3	# tmp1097, _2236, _2312
	andi	a5,a5,0xff	# _2308, tmp1097
.L46:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:472:             BLASLONG ci = n_top * ldc + m_top;
...
.L279:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:481: }
	ld	s0,216(sp)		#,
	.cfi_restore 8
	ld	s1,208(sp)		#,
	.cfi_restore 9
...
.L317:
	...
	.cfi_offset 26, -88
	.cfi_offset 27, -96
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:199:             BLASLONG ai = m_top * K;
	mul	s3,t5,t1	# ai, m_top, K
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:203:             for (BLASLONG k = 0; k < K; k++) {
	ble	t1,zero,.L51	#, K,,
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:204:                 result0 += A[ai + 0] * B[bi + 0];
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:205:                 result1 += A[ai + 0] * B[bi + 1];
	vmacc.vv	v8,v1,v5	# vect_result1_991.411, vect__186.416, vect_array.420,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:206:                 result2 += A[ai + 0] * B[bi + 2];
	vmacc.vv	v9,v1,v6	# vect_result2_993.412, vect__186.416, vect_array.420,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:207:                 result3 += A[ai + 0] * B[bi + 3];
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:216:             C[ci + 3 * ldc + 0] += alpha * result3;
	mulw	s4,s4,s0	# tmp942, _1938, _2317
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:215:             C[ci + 2 * ldc + 0] += alpha * result2;
	mulw	s3,s3,s0	# tmp940, _1976, _2317
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:216:             C[ci + 3 * ldc + 0] += alpha * result3;
	andi	s7,s4,0xff	# _2033, tmp942
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:214:             C[ci + 1 * ldc + 0] += alpha * result1;
	mulw	s1,s1,s0	# tmp938, _1987, _2317
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:215:             C[ci + 2 * ldc + 0] += alpha * result2;
	andi	s6,s3,0xff	# _2030, tmp940
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:213:             C[ci + 0 * ldc + 0] += alpha * result0;
...
.L16:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:212:             BLASLONG ci = n_top * ldc + m_top;
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:216:             C[ci + 3 * ldc + 0] += alpha * result3;
	...
	j	.L15		#
.L315:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:96:             BLASLONG ai = m_top * K;
	mul	s1,t1,t5	# ai, K, m_top
	vsetivli	zero,4,e8,m1,ta,ma	#,,,,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:107:             vint8m1_t result0 = __riscv_vmul_vx_i8m1(A0, B0, gvl);
	lbu	s6,-4(a4)	# MEM[(FLOAT *)_186 + -4B], MEM[(FLOAT *)_186 + -4B]
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:108:             vint8m1_t result1 = __riscv_vmul_vx_i8m1(A0, B1, gvl);
	lbu	s5,-3(a4)	# MEM[(FLOAT *)_186 + -3B], MEM[(FLOAT *)_186 + -3B]
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:109:             vint8m1_t result2 = __riscv_vmul_vx_i8m1(A0, B2, gvl);
	lbu	s4,-2(a4)	# MEM[(FLOAT *)_186 + -2B], MEM[(FLOAT *)_186 + -2B]
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:110:             vint8m1_t result3 = __riscv_vmul_vx_i8m1(A0, B3, gvl);
	lbu	s3,-1(a4)	# MEM[(FLOAT *)_186 + -1B], MEM[(FLOAT *)_186 + -1B]
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:104:             vint8m1_t A0 = __riscv_vle8_v_i8m1(&A[ai + 0 * gvl], gvl);
	add	s2,s10,s1	# ai, _43, A
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:104:             vint8m1_t A0 = __riscv_vle8_v_i8m1(&A[ai + 0 * gvl], gvl);
	vle8.v	v1,0(s2)	# A0,* _43
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:105:             ai += 4;
	addi	s1,s1,4	#, ai, ai
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:107:             vint8m1_t result0 = __riscv_vmul_vx_i8m1(A0, B0, gvl);
	vmul.vx	v3,v1,s6	# result0, A0, MEM[(FLOAT *)_186 + -4B],
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:108:             vint8m1_t result1 = __riscv_vmul_vx_i8m1(A0, B1, gvl);
	vmul.vx	v4,v1,s5	# result1, A0, MEM[(FLOAT *)_186 + -3B],
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:109:             vint8m1_t result2 = __riscv_vmul_vx_i8m1(A0, B2, gvl);
	vmul.vx	v5,v1,s4	# result2, A0, MEM[(FLOAT *)_186 + -2B],
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:110:             vint8m1_t result3 = __riscv_vmul_vx_i8m1(A0, B3, gvl);
	vmul.vx	v1,v1,s3	# result3, A0, MEM[(FLOAT *)_186 + -1B],
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:113:             for (BLASLONG k = 1; k < K; k++) {
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:120:                 A0 = __riscv_vle8_v_i8m1(&A[ai + 0 * gvl], gvl);
	vle8.v	v2,0(s2)	# A0,* ivtmp.626
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:123:                 result0 = __riscv_vmacc_vx_i8m1(result0, B0, A0, gvl);
	lbu	s6,0(a4)	# MEM[(FLOAT *)_1048], MEM[(FLOAT *)_1048]
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:124:                 result1 = __riscv_vmacc_vx_i8m1(result1, B1, A0, gvl);
	lbu	s5,1(a4)	# MEM[(FLOAT *)_1048 + 1B], MEM[(FLOAT *)_1048 + 1B]
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:125:                 result2 = __riscv_vmacc_vx_i8m1(result2, B2, A0, gvl);
	lbu	s4,2(a4)	# MEM[(FLOAT *)_1048 + 2B], MEM[(FLOAT *)_1048 + 2B]
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:126:                 result3 = __riscv_vmacc_vx_i8m1(result3, B3, A0, gvl);
	lbu	s3,3(a4)	# MEM[(FLOAT *)_1048 + 3B], MEM[(FLOAT *)_1048 + 3B]
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:113:             for (BLASLONG k = 1; k < K; k++) {
	addi	s2,s2,4	#, ivtmp.626, ivtmp.626
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:123:                 result0 = __riscv_vmacc_vx_i8m1(result0, B0, A0, gvl);
	vmacc.vx	v3,s6,v2	# result0, MEM[(FLOAT *)_1048], A0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:124:                 result1 = __riscv_vmacc_vx_i8m1(result1, B1, A0, gvl);
	vmacc.vx	v4,s5,v2	# result1, MEM[(FLOAT *)_1048 + 1B], A0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:125:                 result2 = __riscv_vmacc_vx_i8m1(result2, B2, A0, gvl);
	vmacc.vx	v5,s4,v2	# result2, MEM[(FLOAT *)_1048 + 2B], A0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:126:                 result3 = __riscv_vmacc_vx_i8m1(result3, B3, A0, gvl);
	vmacc.vx	v1,s3,v2	# result3, MEM[(FLOAT *)_1048 + 3B], A0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:113:             for (BLASLONG k = 1; k < K; k++) {
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:123:                 result0 = __riscv_vmacc_vx_i8m1(result0, B0, A0, gvl);
	vmacc.vx	v3,s7,v2	# result0, MEM[(FLOAT *)_1048], A0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:124:                 result1 = __riscv_vmacc_vx_i8m1(result1, B1, A0, gvl);
	vmacc.vx	v4,s6,v2	# result1, MEM[(FLOAT *)_1048 + 1B], A0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:125:                 result2 = __riscv_vmacc_vx_i8m1(result2, B2, A0, gvl);
	vmacc.vx	v5,s5,v2	# result2, MEM[(FLOAT *)_1048 + 2B], A0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:126:                 result3 = __riscv_vmacc_vx_i8m1(result3, B3, A0, gvl);
	vmacc.vx	v1,s4,v2	# result3, MEM[(FLOAT *)_1048 + 3B], A0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:120:                 A0 = __riscv_vle8_v_i8m1(&A[ai + 0 * gvl], gvl);
	vle8.v	v2,0(s8)	# A0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:123:                 result0 = __riscv_vmacc_vx_i8m1(result0, B0, A0, gvl);
...
.L10:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:129:             BLASLONG ci = n_top * ldc + m_top;
	add	s1,t6,t5	# m_top, ci, ivtmp.660
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:131:             vint8m1_t c0 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	add	s4,t4,s1	# ci, _56, C
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:131:             vint8m1_t c0 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	vle8.v	v2,0(s4)	# c0,* _56
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:132:             ci += ldc - gvl * 0;
	add	s1,s9,s1	# ci, ci, ldc
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:133:             vint8m1_t c1 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	add	s3,t4,s1	# ci, _58, C
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:133:             vint8m1_t c1 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	vle8.v	v6,0(s3)	# c1,* _58
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:134:             ci += ldc - gvl * 0;
	add	s1,s9,s1	# ci, ci, ldc
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:136:             ci += ldc - gvl * 0;
	add	s2,s9,s1	# ci, ci_747, ldc
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:139:             c0 = __riscv_vmacc_vx_i8m1(c0, alpha, result0, gvl);
	vmv1r.v	v7,v2	# c0, c0
	vmacc.vx	v7,a3,v3	# c0, alpha, result0,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:135:             vint8m1_t c2 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	add	s1,t4,s1	# ci, _60, C
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:137:             vint8m1_t c3 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	add	s2,t4,s2	# ci_747, _62, C
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:135:             vint8m1_t c2 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	vle8.v	v3,0(s1)	# c2,* _60
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:137:             vint8m1_t c3 = __riscv_vle8_v_i8m1(&C[ci], gvl);
	vle8.v	v2,0(s2)	# c3,* _62
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:146:             __riscv_vse8_v_i8m1(&C[ci], c0, gvl);
	vse8.v	v7,0(s4)	# c0,* _56,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:140:             c1 = __riscv_vmacc_vx_i8m1(c1, alpha, result1, gvl);
	vmacc.vx	v6,a3,v4	# c1, alpha, result1,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:153:             m_top += 4;
	addi	t5,t5,4	#, m_top, m_top
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:141:             c2 = __riscv_vmacc_vx_i8m1(c2, alpha, result2, gvl);
	vmacc.vx	v3,a3,v5	# c2, alpha, result2,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:142:             c3 = __riscv_vmacc_vx_i8m1(c3, alpha, result3, gvl);
	vmacc.vx	v2,a3,v1	# c3, alpha, result3,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:148:             __riscv_vse8_v_i8m1(&C[ci], c1, gvl);
	vse8.v	v6,0(s3)	# c1,* _58,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:150:             __riscv_vse8_v_i8m1(&C[ci], c2, gvl);
	vse8.v	v3,0(s1)	# c2,* _60,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:152:             __riscv_vse8_v_i8m1(&C[ci], c3, gvl);
	vse8.v	v2,0(s2)	# c3,* _62,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:156:         if (M & 2) {
	ld	s1,48(sp)		# _63, %sfp
	beq	s1,zero,.L12	#, _63,,
.L316:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:165:             BLASLONG ai = m_top * K;
	mul	s3,t5,t1	# ai, m_top, K
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:169:             for (BLASLONG k = 0; k < K; k++) {
	ble	t1,zero,.L50	#, K,,
	vsetvli	s1,zero,e8,m1,ta,ma	#, tmp1111,,,,
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:170:                 result0 += A[ai + 0] * B[bi + 0];
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:171:                 result1 += A[ai + 1] * B[bi + 0];
	vmacc.vv	v9,v3,v4	# vect_result1_972.456, vect_array.465, vect_array.471,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:172:                 result2 += A[ai + 0] * B[bi + 1];
	vmacc.vv	v10,v2,v5	# vect_result2_974.457, vect_array.465, vect_array.471,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:173:                 result3 += A[ai + 1] * B[bi + 1];
	vmacc.vv	v11,v3,v5	# vect_result3_976.458, vect_array.465, vect_array.471,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:174:                 result4 += A[ai + 0] * B[bi + 2];
	vmacc.vv	v12,v2,v6	# vect_result4_978.459, vect_array.465, vect_array.471,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:175:                 result5 += A[ai + 1] * B[bi + 2];
	vmacc.vv	v13,v3,v6	# vect_result5_980.460, vect_array.465, vect_array.471,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:176:                 result6 += A[ai + 0] * B[bi + 3];
	vmacc.vv	v14,v2,v7	# vect_result6_982.461, vect_array.465, vect_array.471,
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:177:                 result7 += A[ai + 1] * B[bi + 3];
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:186:             C[ci + 1 * ldc + 1] += alpha * result3;
	mulw	s4,s4,s0	# tmp885, _1864, _2317
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:187:             C[ci + 2 * ldc + 0] += alpha * result4;
	andi	s5,s5,0xff	# _1955, tmp887
	sd	s5,96(sp)	# _1955, %sfp
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:185:             C[ci + 1 * ldc + 0] += alpha * result2;
	mulw	s3,s3,s0	# tmp883, _1874, _2317
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:186:             C[ci + 1 * ldc + 1] += alpha * result3;
	andi	s4,s4,0xff	# _1952, tmp885
	sd	s4,16(sp)	# _1952, %sfp
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:190:             C[ci + 3 * ldc + 1] += alpha * result7;
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:188:             C[ci + 2 * ldc + 1] += alpha * result5;
	mulw	s6,s6,s0	# tmp889, _1843, _2317
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:189:             C[ci + 3 * ldc + 0] += alpha * result6;
	andi	s7,s7,0xff	# _1961, tmp891
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:184:             C[ci + 0 * ldc + 1] += alpha * result1;
	mulw	s1,s1,s0	# tmp881, _1885, _2317
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:188:             C[ci + 2 * ldc + 1] += alpha * result5;
	andi	s11,s6,0xff	# _1958, tmp889
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:183:             C[ci + 0 * ldc + 0] += alpha * result0;
...
.L13:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:182:             BLASLONG ci = n_top * ldc + m_top;
	add	s1,t6,t5	# m_top, ci, ivtmp.660
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:183:             C[ci + 0 * ldc + 0] += alpha * result0;
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:191:             m_top += 2;
...
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:190:             C[ci + 3 * ldc + 1] += alpha * result7;
	...
	j	.L12		#
.L49:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:27:         m_top = 0;
	li	t5,0		# m_top,
	j	.L5		#
.L314:
...
.L52:
	.cfi_restore 23
	.cfi_restore 24
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:227:         m_top = 0;
	li	t3,0		# m_top,
	j	.L20		#
.L55:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:370:         m_top = 0;
	li	a1,0		# m_top,
	j	.L35		#
.L48:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:22:     BLASLONG n_top = 0;
	li	a0,0		# n_top,
	j	.L2		#
.L319:
# igemm_kernel_8x4_zvl128b_lmul1_unroll8_i8i32.c:423:                 A0 = __riscv_vle8_v_i8m1(&A[ai + 0 * gvl], gvl);
