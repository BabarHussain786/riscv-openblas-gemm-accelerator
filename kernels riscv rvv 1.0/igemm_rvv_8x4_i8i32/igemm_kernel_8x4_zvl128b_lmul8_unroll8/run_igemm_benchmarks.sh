...
# Log file named for lmul8 unroll8
LOGFILE="benchmark_igemm_8x4_lmul8_unroll8_$(date +%Y%m%d_%H%M%S).log"

echo "======================================================" | tee "$LOGFILE"
echo "RVV IGEMM BENCHMARK (INT8 8x4 - LMUL 8 Unroll 8)" | tee -a "$LOGFILE"
