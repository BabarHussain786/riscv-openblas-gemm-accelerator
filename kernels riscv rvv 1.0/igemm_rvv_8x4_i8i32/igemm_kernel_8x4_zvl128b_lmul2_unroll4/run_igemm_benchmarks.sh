...
# Log file named for lmul2 unroll4
LOGFILE="benchmark_igemm_8x4_lmul2_unroll4_$(date +%Y%m%d_%H%M%S).log"

echo "======================================================" | tee "$LOGFILE"
echo "RVV IGEMM BENCHMARK (INT8 8x4 - LMUL 2 Unroll 4)" | tee -a "$LOGFILE"
