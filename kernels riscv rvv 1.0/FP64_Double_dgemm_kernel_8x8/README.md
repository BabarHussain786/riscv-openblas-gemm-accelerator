# FP64 DGEMM RVV Kernel 8×8 (Zvl128b)
## LMUL × Unrolling-Factor Exploration

This suite evaluates FP64 8×8 DGEMM kernels by sweeping:
...
This suite is an empirical tuning framework to select the best **LMUL + unrolling factor** pair for FP64 8×8 DGEMM on your target RVV platform.