...
/* * AUTOGENERATED KERNEL (Baseline Structure exactly as provided)
 */
int sgemm_kernel_bf16_baseline(BLASLONG M, BLASLONG N, BLASLONG K, FLOAT alpha, IFLOAT *A, IFLOAT *B, FLOAT *C, BLASLONG ldc)
{
    BLASLONG gvl = 0;
    BLASLONG m_top = 0;
    BLASLONG n_top = 0;
