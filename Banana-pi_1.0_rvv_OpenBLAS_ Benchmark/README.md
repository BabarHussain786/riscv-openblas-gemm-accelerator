...
This repository contains optimized SGEMM micro-kernels using the RISC-V Vector Extension (RVV 1.0).
Each benchmark folder contains a separate kernel implementation and its own benchmarking framework.
